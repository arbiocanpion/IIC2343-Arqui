...
{
    class Ret2Instruction : Instruction
    {
        private Dictionary<Tuple<ParameterType, ParameterType>, String> opcodes =
                 ...
                 { new Tuple<ParameterType, ParameterType>(ParameterType.None , ParameterType.None), "1010011"}
        };

        public Ret2Instruction(String param1, String param2) : base(param1, param2){ }
