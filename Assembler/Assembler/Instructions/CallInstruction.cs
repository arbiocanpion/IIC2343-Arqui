...
namespace Assembler.Instructions
{
    class CallInstruction : Instruction
    {
        private Dictionary<Tuple<ParameterType, ParameterType>, String> opcodes =
             ...
             { new Tuple<ParameterType, ParameterType>(ParameterType.Dir , ParameterType.None), "1010010"},
             { new Tuple<ParameterType, ParameterType>(ParameterType.Lit , ParameterType.None), "1010010"}
        };

        public CallInstruction(String param1, String param2) : base(param1, param2){ }
