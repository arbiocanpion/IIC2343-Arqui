...
namespace Assembler.Instructions
{
    class PushInstruction : Instruction
    {
        private Dictionary<Tuple<ParameterType, ParameterType>, String> opcodes =
             ...
             { new Tuple<ParameterType, ParameterType>(ParameterType.A , ParameterType.None), "1001110"},
             { new Tuple<ParameterType, ParameterType>(ParameterType.B , ParameterType.None), "1001111"}
        };

        public PushInstruction(String param1, String param2) : base(param1, param2){ }
