...
{
    class Pop1Instruction : Instruction
    {
        private Dictionary<Tuple<ParameterType, ParameterType>, String> opcodes =
             ...
             { new Tuple<ParameterType, ParameterType>(ParameterType.Lit, ParameterType.None), "1100000"},
        };

        public Pop1Instruction(String param1, String param2) : base(param1, param2){ }
