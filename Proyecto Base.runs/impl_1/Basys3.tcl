...
set rc [catch {
  ...
  set_property ip_repo_paths {{y:/Grupo 1/SegundoAvance/Proyecto Base.cache/ip}} [current_project]
  set_property ip_output_repo {{y:/Grupo 1/SegundoAvance/Proyecto Base.cache/ip}} [current_project]
  add_files -quiet {{Y:/Grupo 1/SegundoAvance/Proyecto Base.runs/synth_1/Basys3.dcp}}
...
set rc [catch {
  ...
  catch {write_hwdef -file Basys3.hwdef}
  place_design 
...
set rc [catch {
  ...
  catch { report_drc -file Basys3_drc_routed.rpt -pb Basys3_drc_routed.pb }
  ...
  catch { report_power -file Basys3_power_routed.rpt -pb Basys3_power_summary_routed.pb }
