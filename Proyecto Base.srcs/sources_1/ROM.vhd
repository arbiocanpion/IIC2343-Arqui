...
signal memory : memory_array:= (
	...
	"111111111111111100000000000000010",	-- instrucción 181 - Assembler.MovInstruction A, Lit
	...
	"000000101100110000000000001010010",	-- instrucción 186 - Assembler.Instructions.CallInstruction Lit, None
	...
	"000000001111011100000000001010010",	-- instrucción 194 - Assembler.Instructions.CallInstruction Lit, None
	"000000010011110100000000001010010",	-- instrucción 195 - Assembler.Instructions.CallInstruction Lit, None
	"000000010101001100000000001010010",	-- instrucción 196 - Assembler.Instructions.CallInstruction Lit, None
	"000000011000100000000000001010111",	-- instrucción 197 - Assembler.Instructions.JmpInstruction Lit, None
	"000000101000000100000000001010010",	-- instrucción 198 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000000000010",	-- instrucción 199 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 200 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100111100000000000000010",	-- instrucción 201 - Assembler.MovInstruction A, Lit
	"000000101000100000000000001010010",	-- instrucción 202 - Assembler.Instructions.CallInstruction Lit, None
	"000000101011101100000000001010010",	-- instrucción 203 - Assembler.Instructions.CallInstruction Lit, None
	"000000101000100000000000001010010",	-- instrucción 204 - Assembler.Instructions.CallInstruction Lit, None
	"000000011110001000000000001010010",	-- instrucción 205 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001001011",	-- instrucción 206 - Assembler.CmpInstruction A, Lit
	"000000001111010100000000001011000",	-- instrucción 207 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000001000000000001001011",	-- instrucción 208 - Assembler.CmpInstruction A, Lit
	"000000001110011000000000001011000",	-- instrucción 209 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000010000000000001001011",	-- instrucción 210 - Assembler.CmpInstruction A, Lit
	"000000001101110000000000001011000",	-- instrucción 211 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000100000000000001001011",	-- instrucción 212 - Assembler.CmpInstruction A, Lit
	"000000001101011100000000001011000",	-- instrucción 213 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000001000000000000001001011",	-- instrucción 214 - Assembler.CmpInstruction A, Lit
	"000000001110101100000000001011000",	-- instrucción 215 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000100111100000000000000010",	-- instrucción 216 - Assembler.MovInstruction A, Lit
	"000000000101011100000000000010000",	-- instrucción 217 - Assembler.AddInstruction A, Dir
	"000000000000000000000000000000001",	-- instrucción 218 - Assembler.MovInstruction B, A
	"000000000000000000000000001001000",	-- instrucción 219 - Assembler.IncInstruction DirB, Lit
	"000000001100010100000000001010111",	-- instrucción 220 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000100111100000000000000010",	-- instrucción 221 - Assembler.MovInstruction A, Lit
	"000000000101011100000000000010000",	-- instrucción 222 - Assembler.AddInstruction A, Dir
	"000000000000000000000000000000001",	-- instrucción 223 - Assembler.MovInstruction B, A
	"000000000000000000000000001001110",	-- instrucción 224 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000001000",	-- instrucción 225 - Assembler.MovInstruction A, DirB
	"000000000000000100000000001001001",	-- instrucción 226 - Assembler.Instructions.DecInstruction A, Lit
	"000000000000000000000000000001010",	-- instrucción 227 - Assembler.MovInstruction DirB, A
	"000000000000000100000000001100000",	-- instrucción 228 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 229 - Assembler.Instructions.Pop2Instruction A, None
	"000000001100010100000000001010111",	-- instrucción 230 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000101011100000000000000100",	-- instrucción 231 - Assembler.MovInstruction A, Dir
	"000000000000001100000000001001011",	-- instrucción 232 - Assembler.CmpInstruction A, Lit
	"000000001110101000000000001011000",	-- instrucción 233 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000101011100000000001000111",	-- instrucción 234 - Assembler.IncInstruction Dir, Lit
	"000000001100010100000000001010111",	-- instrucción 235 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000101011100000000000000100",	-- instrucción 236 - Assembler.MovInstruction A, Dir
	"000000000000000000000000001001011",	-- instrucción 237 - Assembler.CmpInstruction A, Lit
	"000000001111010000000000001011000",	-- instrucción 238 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000000000000000001001110",	-- instrucción 239 - Assembler.Instructions.PushInstruction A, None
	"000000000101011100000000000000100",	-- instrucción 240 - Assembler.MovInstruction A, Dir
	"000000000000000100000000001001001",	-- instrucción 241 - Assembler.Instructions.DecInstruction A, Lit
	"000000000101011100000000000000110",	-- instrucción 242 - Assembler.MovInstruction Dir, A
	"000000000000000100000000001100000",	-- instrucción 243 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 244 - Assembler.Instructions.Pop2Instruction A, None
	"000000001100010100000000001010111",	-- instrucción 245 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 246 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 247 - Assembler.Instructions.Ret2Instruction None, None
	"000000000001000000000000000000010",	-- instrucción 248 - Assembler.MovInstruction A, Lit
	"000000101000000100000000001010010",	-- instrucción 249 - Assembler.Instructions.CallInstruction Lit, None
	"000000101011101100000000001010010",	-- instrucción 250 - Assembler.Instructions.CallInstruction Lit, None
	"000000000101001100000000000000010",	-- instrucción 251 - Assembler.MovInstruction A, Lit
	"000000101000100000000000001010010",	-- instrucción 252 - Assembler.Instructions.CallInstruction Lit, None
	"000000101011101100000000001010010",	-- instrucción 253 - Assembler.Instructions.CallInstruction Lit, None
	"000000011110001000000000001010010",	-- instrucción 254 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001001011",	-- instrucción 255 - Assembler.CmpInstruction A, Lit
	"000000010010011000000000001011000",	-- instrucción 256 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000001000000000001001011",	-- instrucción 257 - Assembler.CmpInstruction A, Lit
	"000000010001011100000000001011000",	-- instrucción 258 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000010000000000001001011",	-- instrucción 259 - Assembler.CmpInstruction A, Lit
	"000000010000110100000000001011000",	-- instrucción 260 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000100000000000001001011",	-- instrucción 261 - Assembler.CmpInstruction A, Lit
	"000000010000100000000000001011000",	-- instrucción 262 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000001000000000000001001011",	-- instrucción 263 - Assembler.CmpInstruction A, Lit
	"000000010001110000000000001011000",	-- instrucción 264 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000101001100000000000000010",	-- instrucción 265 - Assembler.MovInstruction A, Lit
	"000000000101011100000000000010000",	-- instrucción 266 - Assembler.AddInstruction A, Dir
	"000000000000000000000000000000001",	-- instrucción 267 - Assembler.MovInstruction B, A
	"000000000000000000000000001001000",	-- instrucción 268 - Assembler.IncInstruction DirB, Lit
	"000000001111011100000000001010111",	-- instrucción 269 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000101001100000000000000010",	-- instrucción 270 - Assembler.MovInstruction A, Lit
	"000000000101011100000000000010000",	-- instrucción 271 - Assembler.AddInstruction A, Dir
	"000000000000000000000000000000001",	-- instrucción 272 - Assembler.MovInstruction B, A
	"000000000000000000000000001001110",	-- instrucción 273 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000001000",	-- instrucción 274 - Assembler.MovInstruction A, DirB
	"000000000000000100000000001001001",	-- instrucción 275 - Assembler.Instructions.DecInstruction A, Lit
	"000000000000000000000000000001010",	-- instrucción 276 - Assembler.MovInstruction DirB, A
	"000000000000000100000000001100000",	-- instrucción 277 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 278 - Assembler.Instructions.Pop2Instruction A, None
	"000000001111011100000000001010111",	-- instrucción 279 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000101011100000000000000100",	-- instrucción 280 - Assembler.MovInstruction A, Dir
	"000000000000001100000000001001011",	-- instrucción 281 - Assembler.CmpInstruction A, Lit
	"000000010001101100000000001011000",	-- instrucción 282 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000101011100000000001000111",	-- instrucción 283 - Assembler.IncInstruction Dir, Lit
	"000000001111011100000000001010111",	-- instrucción 284 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000101011100000000000000100",	-- instrucción 285 - Assembler.MovInstruction A, Dir
	"000000000000000000000000001001011",	-- instrucción 286 - Assembler.CmpInstruction A, Lit
	"000000010010010100000000001011000",	-- instrucción 287 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000000000000000001001110",	-- instrucción 288 - Assembler.Instructions.PushInstruction A, None
	"000000000101011100000000000000100",	-- instrucción 289 - Assembler.MovInstruction A, Dir
	"000000000000000100000000001001001",	-- instrucción 290 - Assembler.Instructions.DecInstruction A, Lit
	"000000000101011100000000000000110",	-- instrucción 291 - Assembler.MovInstruction Dir, A
	"000000000000000100000000001100000",	-- instrucción 292 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 293 - Assembler.Instructions.Pop2Instruction A, None
	"000000001111011100000000001010111",	-- instrucción 294 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 295 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 296 - Assembler.Instructions.Ret2Instruction None, None
	"000000101000000100000000001010010",	-- instrucción 297 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100111100000000000000010",	-- instrucción 298 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 299 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110000000000000000010",	-- instrucción 300 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 301 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110100000000000000010",	-- instrucción 302 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 303 - Assembler.Instructions.CallInstruction Lit, None
	"000000000101100000000000000000010",	-- instrucción 304 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 305 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110100000000000000010",	-- instrucción 306 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 307 - Assembler.Instructions.CallInstruction Lit, None
	"000000000101001100000000000000010",	-- instrucción 308 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 309 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110000000000000000010",	-- instrucción 310 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 311 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110100000000000000010",	-- instrucción 312 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 313 - Assembler.Instructions.CallInstruction Lit, None
	"000000000101100100000000000000010",	-- instrucción 314 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 315 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 316 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 317 - Assembler.Instructions.Ret2Instruction None, None
	"000000000010000000000000000000100",	-- instrucción 318 - Assembler.MovInstruction A, Dir
	"000000000000000000000000001001011",	-- instrucción 319 - Assembler.CmpInstruction A, Lit
	"000000010100001000000000001011000",	-- instrucción 320 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000101001100000000000000100",	-- instrucción 321 - Assembler.MovInstruction A, Dir
	"000000010100001100000000001010111",	-- instrucción 322 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000100111100000000000000100",	-- instrucción 323 - Assembler.MovInstruction A, Dir
	"000000101000100000000000001010010",	-- instrucción 324 - Assembler.Instructions.CallInstruction Lit, None
	"000000101011101100000000001010010",	-- instrucción 325 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110000000000000000010",	-- instrucción 326 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 327 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110100000000000000010",	-- instrucción 328 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 329 - Assembler.Instructions.CallInstruction Lit, None
	"000000000010000100000000000000010",	-- instrucción 330 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 331 - Assembler.Instructions.CallInstruction Lit, None
	"000000011110001000000000001010010",	-- instrucción 332 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001001011",	-- instrucción 333 - Assembler.CmpInstruction A, Lit
	"000000010100111100000000001011000",	-- instrucción 334 - Assembler.Instructions.JeqInstruction Lit, None
	"000000010100101100000000001010111",	-- instrucción 335 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000000000000001010100",	-- instrucción 336 - Assembler.Instructions.InInstruction A, Lit
	"000000000100111000000000000000110",	-- instrucción 337 - Assembler.MovInstruction Dir, A
	...
	"000000000010000000000000000000100",	-- instrucción 340 - Assembler.MovInstruction A, Dir
	"000000000000000000000000001001011",	-- instrucción 341 - Assembler.CmpInstruction A, Lit
	"000000010101100000000000001011000",	-- instrucción 342 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000101001100000000000000100",	-- instrucción 343 - Assembler.MovInstruction A, Dir
	"000000010101100100000000001010111",	-- instrucción 344 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000100111100000000000000100",	-- instrucción 345 - Assembler.MovInstruction A, Dir
	"000000101000100000000000001010010",	-- instrucción 346 - Assembler.Instructions.CallInstruction Lit, None
	"000000101011101100000000001010010",	-- instrucción 347 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110000000000000000010",	-- instrucción 348 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 349 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110100000000000000010",	-- instrucción 350 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 351 - Assembler.Instructions.CallInstruction Lit, None
	"000000000010000100000000000000010",	-- instrucción 352 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 353 - Assembler.Instructions.CallInstruction Lit, None
	"000000011110001000000000001010010",	-- instrucción 354 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 355 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 356 - Assembler.Instructions.Ret2Instruction None, None
	"000000010110010000000000000000010",	-- instrucción 357 - Assembler.MovInstruction A, Lit
	"000000101000100000000000001010010",	-- instrucción 358 - Assembler.Instructions.CallInstruction Lit, None
	"000000011110001000000000001010010",	-- instrucción 359 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001001011",	-- instrucción 360 - Assembler.CmpInstruction A, Lit
	"000000011010000100000000001011000",	-- instrucción 361 - Assembler.Instructions.JeqInstruction Lit, None
	"000000001011101000000000001010111",	-- instrucción 362 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000010000000000000000000100",	-- instrucción 363 - Assembler.MovInstruction A, Dir
	"000000000000000000000000001001011",	-- instrucción 364 - Assembler.CmpInstruction A, Lit
	"000000010111000000000000001011000",	-- instrucción 365 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000101100100000000001000111",	-- instrucción 366 - Assembler.IncInstruction Dir, Lit
	"000000000101001100000000000000100",	-- instrucción 367 - Assembler.MovInstruction A, Dir
	"000000010111001000000000001010111",	-- instrucción 368 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000101100100000000001000111",	-- instrucción 369 - Assembler.IncInstruction Dir, Lit
	"000000000100111100000000000000100",	-- instrucción 370 - Assembler.MovInstruction A, Dir
	"000000101000100000000000001010010",	-- instrucción 371 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110100000000000000100",	-- instrucción 372 - Assembler.MovInstruction A, Dir
	"000000101011101100000000001010010",	-- instrucción 373 - Assembler.Instructions.CallInstruction Lit, None
	"000000000011010100000000000000100",	-- instrucción 374 - Assembler.MovInstruction A, Dir
	"000000101011101100000000001010010",	-- instrucción 375 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 376 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 377 - Assembler.Instructions.Ret2Instruction None, None
	"000000000010000000000000000000100",	-- instrucción 378 - Assembler.MovInstruction A, Dir
	"000000000000000000000000001001011",	-- instrucción 379 - Assembler.CmpInstruction A, Lit
	"000000010111111100000000001011000",	-- instrucción 380 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000101100000000000001000111",	-- instrucción 381 - Assembler.IncInstruction Dir, Lit
	"000000000101001100000000000000100",	-- instrucción 382 - Assembler.MovInstruction A, Dir
	"000000011000000100000000001010111",	-- instrucción 383 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000101100100000000001000111",	-- instrucción 384 - Assembler.IncInstruction Dir, Lit
	"000000000100111100000000000000100",	-- instrucción 385 - Assembler.MovInstruction A, Dir
	"000000101000100000000000001010010",	-- instrucción 386 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110100000000000000100",	-- instrucción 387 - Assembler.MovInstruction A, Dir
	"000000101011101100000000001010010",	-- instrucción 388 - Assembler.Instructions.CallInstruction Lit, None
	"000000000011100100000000000000100",	-- instrucción 389 - Assembler.MovInstruction A, Dir
	"000000101011101100000000001010010",	-- instrucción 390 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 391 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 392 - Assembler.Instructions.Ret2Instruction None, None
	"000000010010100000000000001010010",	-- instrucción 393 - Assembler.Instructions.CallInstruction Lit, None
	"000000101000100000000000001010010",	-- instrucción 394 - Assembler.Instructions.CallInstruction Lit, None
	"000000011001000000000000001010010",	-- instrucción 395 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110100000000000000010",	-- instrucción 396 - Assembler.MovInstruction A, Lit
	"000000100110100000000000001010010",	-- instrucción 397 - Assembler.Instructions.CallInstruction Lit, None
	"000000000010111000000000000000010",	-- instrucción 398 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 399 - Assembler.Instructions.CallInstruction Lit, None
	"000000011010000100000000001010111",	-- instrucción 400 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000010000000000000000000010",	-- instrucción 401 - Assembler.MovInstruction A, Lit
	"000000000000000000000000001001011",	-- instrucción 402 - Assembler.CmpInstruction A, Lit
	"000000011001011100000000001011000",	-- instrucción 403 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000101001100000000000000010",	-- instrucción 404 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 405 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 406 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 407 - Assembler.Instructions.Ret2Instruction None, None
	"000000000100111100000000000000010",	-- instrucción 408 - Assembler.MovInstruction A, Lit
	"000000101011101100000000001010010",	-- instrucción 409 - Assembler.Instructions.CallInstruction Lit, None
	"000000011001110000000000001010010",	-- instrucción 410 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 411 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 412 - Assembler.Instructions.Ret2Instruction None, None
	"000000000010000000000000000000100",	-- instrucción 413 - Assembler.MovInstruction A, Dir
	"000000000000000000000000000111001",	-- instrucción 414 - Assembler.NotInstruction A, None
	"000000000010000000000000000000110",	-- instrucción 415 - Assembler.MovInstruction Dir, A
	"000000000000000100000000001100001",	-- instrucción 416 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 417 - Assembler.Instructions.Ret2Instruction None, None
	"000000011100100100000000001010010",	-- instrucción 418 - Assembler.Instructions.CallInstruction Lit, None
	"000000000101101000000000000000100",	-- instrucción 419 - Assembler.MovInstruction A, Dir
	"000000000000000000000000001001011",	-- instrucción 420 - Assembler.CmpInstruction A, Lit
	"000000010111100100000000001011000",	-- instrucción 421 - Assembler.Instructions.JeqInstruction Lit, None
	"000000011110001000000000001010010",	-- instrucción 422 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000000000001",	-- instrucción 423 - Assembler.MovInstruction B, A
	"000000000000000000000000001010100",	-- instrucción 424 - Assembler.Instructions.InInstruction A, Lit
	"000000000100111000000000001001100",	-- instrucción 425 - Assembler.CmpInstruction A, Dir
	"000000010110101000000000001011000",	-- instrucción 426 - Assembler.Instructions.JeqInstruction Lit, None
	"000000011101110100000000001010010",	-- instrucción 427 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001001011",	-- instrucción 428 - Assembler.CmpInstruction A, Lit
	"000000011011010100000000001011000",	-- instrucción 429 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000001000000000001001011",	-- instrucción 430 - Assembler.CmpInstruction A, Lit
	"000000011011100100000000001011000",	-- instrucción 431 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000010000000000001001011",	-- instrucción 432 - Assembler.CmpInstruction A, Lit
	"000000011011110100000000001011000",	-- instrucción 433 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000100000000000001001011",	-- instrucción 434 - Assembler.CmpInstruction A, Lit
	"000000011100000100000000001011000",	-- instrucción 435 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000001000000000000001001011",	-- instrucción 436 - Assembler.CmpInstruction A, Lit
	"000000011100010100000000001011000",	-- instrucción 437 - Assembler.Instructions.JeqInstruction Lit, None
	"000000011101110100000000001010010",	-- instrucción 438 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100111000000000000100010",	-- instrucción 439 - Assembler.AndInstruction A, Dir
	"000000011101000000000000001010010",	-- instrucción 440 - Assembler.Instructions.CallInstruction Lit, None
	"000000011010000100000000001010111",	-- instrucción 441 - Assembler.Instructions.JmpInstruction Lit, None
	"000000011101110100000000001010010",	-- instrucción 442 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100111000000000000010000",	-- instrucción 443 - Assembler.AddInstruction A, Dir
	"000000011101000000000000001010010",	-- instrucción 444 - Assembler.Instructions.CallInstruction Lit, None
	"000000011010000100000000001010111",	-- instrucción 445 - Assembler.Instructions.JmpInstruction Lit, None
	"000000011101110100000000001010010",	-- instrucción 446 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100111000000000000101011",	-- instrucción 447 - Assembler.OrInstruction A, Dir
	"000000011101000000000000001010010",	-- instrucción 448 - Assembler.Instructions.CallInstruction Lit, None
	"000000011010000100000000001010111",	-- instrucción 449 - Assembler.Instructions.JmpInstruction Lit, None
	"000000011101110100000000001010010",	-- instrucción 450 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100111000000000000110100",	-- instrucción 451 - Assembler.XorInstruction A, Dir
	"000000011101000000000000001010010",	-- instrucción 452 - Assembler.Instructions.CallInstruction Lit, None
	"000000011010000100000000001010111",	-- instrucción 453 - Assembler.Instructions.JmpInstruction Lit, None
	"000000011101110100000000001010010",	-- instrucción 454 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100111000000000000011001",	-- instrucción 455 - Assembler.SubInstruction A, Dir
	"000000011101000000000000001010010",	-- instrucción 456 - Assembler.Instructions.CallInstruction Lit, None
	"000000011010000100000000001010111",	-- instrucción 457 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000000000000001001110",	-- instrucción 458 - Assembler.Instructions.PushInstruction A, None
	"000000000101101000000000000000100",	-- instrucción 459 - Assembler.MovInstruction A, Dir
	"000000000000000100000000001100101",	-- instrucción 460 - Assembler.Instructions.OutInstruction A, Lit
	"000000000000000100000000001100000",	-- instrucción 461 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 462 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 463 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 464 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 465 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 466 - Assembler.Instructions.PushInstruction B, None
	"000000000101101000000000000000100",	-- instrucción 467 - Assembler.MovInstruction A, Dir
	"000000000101101100000000000000101",	-- instrucción 468 - Assembler.MovInstruction B, Dir
	"000000000000000000000000000010101",	-- instrucción 469 - Assembler.SubInstruction A, B
	"000000000101101000000000000000110",	-- instrucción 470 - Assembler.MovInstruction Dir, A
	"000000000000000000000000000000000",	-- instrucción 471 - Assembler.MovInstruction A, B
	"000000000000000000000000000001100",	-- instrucción 472 - Assembler.AddInstruction A, B
	"000000000101101100000000000000110",	-- instrucción 473 - Assembler.MovInstruction Dir, A
	"000000000000000100000000001100000",	-- instrucción 474 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 475 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100000",	-- instrucción 476 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 477 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000000000000000110000",	-- instrucción 478 - Assembler.XorInstruction A, B
	"000000000000000000000000000110001",	-- instrucción 479 - Assembler.XorInstruction B, A
	"000000000000000000000000000110000",	-- instrucción 480 - Assembler.XorInstruction A, B
	"000000000000000100000000001100001",	-- instrucción 481 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 482 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001111",	-- instrucción 483 - Assembler.Instructions.PushInstruction B, None
	"000000000000000100000000001010100",	-- instrucción 484 - Assembler.Instructions.InInstruction A, Lit
	"000000000000000100000000001010101",	-- instrucción 485 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 486 - Assembler.CmpInstruction A, B
	"000000011110010000000000001011000",	-- instrucción 487 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000000000000000000110001",	-- instrucción 488 - Assembler.XorInstruction B, A
	"000000000000000100000000001010100",	-- instrucción 489 - Assembler.Instructions.InInstruction A, Lit
	"000000000000000000000000000011110",	-- instrucción 490 - Assembler.AndInstruction A, B
	"000000000000000000000000001001011",	-- instrucción 491 - Assembler.CmpInstruction A, Lit
	"000000011110100000000000001011001",	-- instrucción 492 - Assembler.Instructions.JneInstruction Lit, None
	"000000000000000000000000000000000",	-- instrucción 493 - Assembler.MovInstruction A, B
	"000000000000000100000000001100000",	-- instrucción 494 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 495 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100001",	-- instrucción 496 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 497 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001111",	-- instrucción 498 - Assembler.Instructions.PushInstruction B, None
	"000000000000001000000000001010101",	-- instrucción 499 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 500 - Assembler.CmpInstruction A, B
	"000000011111001000000000001011010",	-- instrucción 501 - Assembler.Instructions.JgtInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 502 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 503 - Assembler.Instructions.Pop2Instruction B, None
	"000000011111101100000000001010111",	-- instrucción 504 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000000000000000000001",	-- instrucción 505 - Assembler.MovInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 506 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 507 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000000000000001001111",	-- instrucción 508 - Assembler.Instructions.PushInstruction B, None
	"000000000000001000000000001010101",	-- instrucción 509 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 510 - Assembler.CmpInstruction A, B
	"000000100000101100000000001011001",	-- instrucción 511 - Assembler.Instructions.JneInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 512 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 513 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000000000000001001110",	-- instrucción 514 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000000000",	-- instrucción 515 - Assembler.MovInstruction A, B
	"000000000000001100000000001010101",	-- instrucción 516 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 517 - Assembler.CmpInstruction A, B
	"000000011111100000000000001011010",	-- instrucción 518 - Assembler.Instructions.JgtInstruction Lit, None
	"000000000000000000000000000000001",	-- instrucción 519 - Assembler.MovInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 520 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 521 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 522 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 523 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000100000000001100000",	-- instrucción 524 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 525 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100001",	-- instrucción 526 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 527 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 528 - Assembler.Instructions.PushInstruction A, None
	"000000100001010000000000001010111",	-- instrucción 529 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000000000000000000001",	-- instrucción 530 - Assembler.MovInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 531 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 532 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000000000000001001111",	-- instrucción 533 - Assembler.Instructions.PushInstruction B, None
	"000000000000001100000000001010101",	-- instrucción 534 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 535 - Assembler.CmpInstruction A, B
	"000000100010011000000000001011001",	-- instrucción 536 - Assembler.Instructions.JneInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 537 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 538 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000000000000001001110",	-- instrucción 539 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000000000",	-- instrucción 540 - Assembler.MovInstruction A, B
	"000000000000010000000000001010101",	-- instrucción 541 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 542 - Assembler.CmpInstruction A, B
	"000000100001000100000000001011010",	-- instrucción 543 - Assembler.Instructions.JgtInstruction Lit, None
	"000000000000000000000000000000001",	-- instrucción 544 - Assembler.MovInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 545 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 546 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100000",	-- instrucción 547 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 548 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 549 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 550 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000100000000001100000",	-- instrucción 551 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 552 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100000",	-- instrucción 553 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 554 - Assembler.Instructions.Pop2Instruction A, None
	...
	"000000000000000000000000001001111",	-- instrucción 558 - Assembler.Instructions.PushInstruction B, None
	"000000000000001100000000001010101",	-- instrucción 559 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000000001100",	-- instrucción 560 - Assembler.AddInstruction A, B
	"000000000000001000000000001010101",	-- instrucción 561 - Assembler.Instructions.InInstruction B, Lit
	"000000111110100000000000001001011",	-- instrucción 562 - Assembler.CmpInstruction A, Lit
	"000000100011011000000000001011100",	-- instrucción 563 - Assembler.Instructions.JltInstruction Lit, None
	"000000111110100000000000000010111",	-- instrucción 564 - Assembler.SubInstruction A, Lit
	"000000000000000000000000001000110",	-- instrucción 565 - Assembler.IncInstruction B, Lit
	"000000100011000100000000001010111",	-- instrucción 566 - Assembler.Instructions.JmpInstruction Lit, None
	"000000011101110100000000001010010",	-- instrucción 567 - Assembler.Instructions.CallInstruction Lit, None
	"000000011111000100000000001010010",	-- instrucción 568 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 569 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 570 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100000",	-- instrucción 571 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 572 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 573 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 574 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 575 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 576 - Assembler.Instructions.PushInstruction B, None
	"000000000000010000000000001010101",	-- instrucción 577 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000000001100",	-- instrucción 578 - Assembler.AddInstruction A, B
	"000000000000000100000000001000101",	-- instrucción 579 - Assembler.IncInstruction A, Lit
	"000000000000000000000000000000011",	-- instrucción 580 - Assembler.MovInstruction B, Lit
	"000000111110100000000000001001011",	-- instrucción 581 - Assembler.CmpInstruction A, Lit
	"000000100100100100000000001011100",	-- instrucción 582 - Assembler.Instructions.JltInstruction Lit, None
	"000000111110100000000000000010111",	-- instrucción 583 - Assembler.SubInstruction A, Lit
	"000000000000000000000000001000110",	-- instrucción 584 - Assembler.IncInstruction B, Lit
	"000000100100010000000000001010111",	-- instrucción 585 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000000000000001001011",	-- instrucción 586 - Assembler.CmpInstruction A, Lit
	"000000100100110000000000001011000",	-- instrucción 587 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000000100000000001001001",	-- instrucción 588 - Assembler.Instructions.DecInstruction A, Lit
	"000000000000000000000000001001110",	-- instrucción 589 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 590 - Assembler.Instructions.PushInstruction B, None
	"000000000000001100000000001010100",	-- instrucción 591 - Assembler.Instructions.InInstruction A, Lit
	"000000000000000000000000000001101",	-- instrucción 592 - Assembler.AddInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 593 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 594 - Assembler.Instructions.Pop2Instruction A, None
	"000000100010110000000000001010010",	-- instrucción 595 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000000000000",	-- instrucción 596 - Assembler.MovInstruction A, B
	"000000111110100000000000001001011",	-- instrucción 597 - Assembler.CmpInstruction A, Lit
	"000000100101011100000000001011100",	-- instrucción 598 - Assembler.Instructions.JltInstruction Lit, None
	"000000111110100000000000000010111",	-- instrucción 599 - Assembler.SubInstruction A, Lit
	"000000000000000100000000001100000",	-- instrucción 600 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 601 - Assembler.Instructions.Pop2Instruction B, None
	"000000100000111100000000001010010",	-- instrucción 602 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 603 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 604 - Assembler.Instructions.Pop2Instruction B, None
	...
	"000000000000000000000000001001110",	-- instrucción 609 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001100010",	-- instrucción 610 - Assembler.Instructions.OutInstruction A, B
	"000000000010011100000000000000010",	-- instrucción 611 - Assembler.MovInstruction A, Lit
	"000000100011111000000000001010010",	-- instrucción 612 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 613 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 614 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 615 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 616 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 617 - Assembler.Instructions.PushInstruction A, None
	"000000100000000000000000000101001",	-- instrucción 618 - Assembler.OrInstruction A, Lit
	"000000100110000000000000001010010",	-- instrucción 619 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 620 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 621 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 622 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 623 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 624 - Assembler.Instructions.PushInstruction A, None
	"000000000000000100000000000000010",	-- instrucción 625 - Assembler.MovInstruction A, Lit
	"000000100110000000000000001010010",	-- instrucción 626 - Assembler.Instructions.CallInstruction Lit, None
	"000001011111101000000000000000010",	-- instrucción 627 - Assembler.MovInstruction A, Lit
	"000000100011111000000000001010010",	-- instrucción 628 - Assembler.Instructions.CallInstruction Lit, None
	...
	"000000000000001000000000000000010",	-- instrucción 634 - Assembler.MovInstruction A, Lit
	"000000100110000000000000001010010",	-- instrucción 635 - Assembler.Instructions.CallInstruction Lit, None
	"000001011111101000000000000000010",	-- instrucción 636 - Assembler.MovInstruction A, Lit
	"000000100011111000000000001010010",	-- instrucción 637 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 638 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 639 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 640 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 641 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 642 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000000010",	-- instrucción 643 - Assembler.MovInstruction A, Lit
	"000000101000111100000000001010010",	-- instrucción 644 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 645 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 646 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 647 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 648 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 649 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000000010",	-- instrucción 650 - Assembler.MovInstruction A, Lit
	"000000101001011100000000001010010",	-- instrucción 651 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 652 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 653 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 654 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 655 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 656 - Assembler.Instructions.PushInstruction A, None
	"000000001000000000000000000101001",	-- instrucción 657 - Assembler.OrInstruction A, Lit
	"000000000101011100000000000000110",	-- instrucción 658 - Assembler.MovInstruction Dir, A
	"000000100110000000000000001010010",	-- instrucción 659 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 660 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 661 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 662 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 663 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 664 - Assembler.Instructions.PushInstruction A, None
	"000000001100000000000000000101001",	-- instrucción 665 - Assembler.OrInstruction A, Lit
	"000000000101011100000000000000110",	-- instrucción 666 - Assembler.MovInstruction Dir, A
	"000000100110000000000000001010010",	-- instrucción 667 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 668 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 669 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 670 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 671 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 672 - Assembler.Instructions.PushInstruction A, None
	"000000000001100000000000000000010",	-- instrucción 673 - Assembler.MovInstruction A, Lit
	"000000100110000000000000001010010",	-- instrucción 674 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 675 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 676 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 677 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 678 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 679 - Assembler.Instructions.PushInstruction A, None
	"000000000001110000000000000000010",	-- instrucción 680 - Assembler.MovInstruction A, Lit
	"000000100110000000000000001010010",	-- instrucción 681 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 682 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 683 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 684 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 685 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 686 - Assembler.Instructions.PushInstruction A, None
	"000000000001000000000000000000010",	-- instrucción 687 - Assembler.MovInstruction A, Lit
	"000000100110000000000000001010010",	-- instrucción 688 - Assembler.Instructions.CallInstruction Lit, None
	...
	"000000000001010000000000000000010",	-- instrucción 694 - Assembler.MovInstruction A, Lit
	"000000100110000000000000001010010",	-- instrucción 695 - Assembler.Instructions.CallInstruction Lit, None
	...
	"000000000000000000000000001001111",	-- instrucción 701 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000000000001",	-- instrucción 702 - Assembler.MovInstruction B, A
	"000000000000000000000000000001000",	-- instrucción 703 - Assembler.MovInstruction A, DirB
	"000000000000000100000000001100000",	-- instrucción 704 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 705 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000000000000001001011",	-- instrucción 706 - Assembler.CmpInstruction A, Lit
	"000000101100100000000000001011000",	-- instrucción 707 - Assembler.Instructions.JeqInstruction Lit, None
	"000000100110100000000000001010010",	-- instrucción 708 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 709 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 710 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001000101",	-- instrucción 711 - Assembler.IncInstruction A, Lit
	"000000101011101100000000001010111",	-- instrucción 712 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 713 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 714 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 715 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 716 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 717 - Assembler.Instructions.PushInstruction A, None
	"000000000001111000000000000000010",	-- instrucción 718 - Assembler.MovInstruction A, Lit
	"000000100010110000000000001010010",	-- instrucción 719 - Assembler.Instructions.CallInstruction Lit, None
	"000000000011110000000000000000010",	-- instrucción 720 - Assembler.MovInstruction A, Lit
	"000000100110000000000000001010010",	-- instrucción 721 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000111100000000000000010",	-- instrucción 722 - Assembler.MovInstruction A, Lit
	"000000100110000000000000001010010",	-- instrucción 723 - Assembler.Instructions.CallInstruction Lit, None
	"000000100110111100000000001010010",	-- instrucción 724 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000011000000000000000010",	-- instrucción 725 - Assembler.MovInstruction A, Lit
	"000000100110000000000000001010010",	-- instrucción 726 - Assembler.Instructions.CallInstruction Lit, None
	"000000100111100000000000001010010",	-- instrucción 727 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 728 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 729 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 730 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 731 - Assembler.Instructions.Ret2Instruction None, None
