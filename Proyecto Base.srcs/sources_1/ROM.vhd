...
signal memory : memory_array:= (
	...
	"000000000100100100000000000000010",	-- instrucción 67 - Assembler.MovInstruction A, Lit
	"000000000010000100000000000000110",	-- instrucción 68 - Assembler.MovInstruction Dir, A
	"000000000110111000000000000000010",	-- instrucción 69 - Assembler.MovInstruction A, Lit
	"000000000010001000000000000000110",	-- instrucción 70 - Assembler.MovInstruction Dir, A
	"000000000110011100000000000000010",	-- instrucción 71 - Assembler.MovInstruction A, Lit
	"000000000010001100000000000000110",	-- instrucción 72 - Assembler.MovInstruction Dir, A
	"000000000111001000000000000000010",	-- instrucción 73 - Assembler.MovInstruction A, Lit
	"000000000010010000000000000000110",	-- instrucción 74 - Assembler.MovInstruction Dir, A
	"000000000110010100000000000000010",	-- instrucción 75 - Assembler.MovInstruction A, Lit
	"000000000010010100000000000000110",	-- instrucción 76 - Assembler.MovInstruction Dir, A
	"000000000111001100000000000000010",	-- instrucción 77 - Assembler.MovInstruction A, Lit
	"000000000010011000000000000000110",	-- instrucción 78 - Assembler.MovInstruction Dir, A
	"000000000110000100000000000000010",	-- instrucción 79 - Assembler.MovInstruction A, Lit
	"000000000010011100000000000000110",	-- instrucción 80 - Assembler.MovInstruction Dir, A
	"000000000100110000000000000000010",	-- instrucción 81 - Assembler.MovInstruction A, Lit
	"000000000010100000000000000000110",	-- instrucción 82 - Assembler.MovInstruction Dir, A
	"000000000110100100000000000000010",	-- instrucción 83 - Assembler.MovInstruction A, Lit
	"000000000010100100000000000000110",	-- instrucción 84 - Assembler.MovInstruction Dir, A
	"000000000110110100000000000000010",	-- instrucción 85 - Assembler.MovInstruction A, Lit
	"000000000010101000000000000000110",	-- instrucción 86 - Assembler.MovInstruction Dir, A
	"000000000111000000000000000000010",	-- instrucción 87 - Assembler.MovInstruction A, Lit
	"000000000010101100000000000000110",	-- instrucción 88 - Assembler.MovInstruction Dir, A
	"000000000110100100000000000000010",	-- instrucción 89 - Assembler.MovInstruction A, Lit
	"000000000010110000000000000000110",	-- instrucción 90 - Assembler.MovInstruction Dir, A
	"000000000110000100000000000000010",	-- instrucción 91 - Assembler.MovInstruction A, Lit
	"000000000010110100000000000000110",	-- instrucción 92 - Assembler.MovInstruction Dir, A
	"000000000100000100000000000000010",	-- instrucción 93 - Assembler.MovInstruction A, Lit
	"000000000010111000000000000000110",	-- instrucción 94 - Assembler.MovInstruction Dir, A
	"000000000110010000000000000000010",	-- instrucción 95 - Assembler.MovInstruction A, Lit
	"000000000010111100000000000000110",	-- instrucción 96 - Assembler.MovInstruction Dir, A
	"000000000110100100000000000000010",	-- instrucción 97 - Assembler.MovInstruction A, Lit
	"000000000011000000000000000000110",	-- instrucción 98 - Assembler.MovInstruction Dir, A
	"000000000111011000000000000000010",	-- instrucción 99 - Assembler.MovInstruction A, Lit
	"000000000011000100000000000000110",	-- instrucción 100 - Assembler.MovInstruction Dir, A
	"000000000110100100000000000000010",	-- instrucción 101 - Assembler.MovInstruction A, Lit
	"000000000011001000000000000000110",	-- instrucción 102 - Assembler.MovInstruction Dir, A
	"000000000110111000000000000000010",	-- instrucción 103 - Assembler.MovInstruction A, Lit
	"000000000011001100000000000000110",	-- instrucción 104 - Assembler.MovInstruction Dir, A
	"000000000110000100000000000000010",	-- instrucción 105 - Assembler.MovInstruction A, Lit
	"000000000011010000000000000000110",	-- instrucción 106 - Assembler.MovInstruction Dir, A
	"000000000100011100000000000000010",	-- instrucción 107 - Assembler.MovInstruction A, Lit
	"000000000011010100000000000000110",	-- instrucción 108 - Assembler.MovInstruction Dir, A
	"000000000110000100000000000000010",	-- instrucción 109 - Assembler.MovInstruction A, Lit
	"000000000011011000000000000000110",	-- instrucción 110 - Assembler.MovInstruction Dir, A
	"000000000110111000000000000000010",	-- instrucción 111 - Assembler.MovInstruction A, Lit
	"000000000011011100000000000000110",	-- instrucción 112 - Assembler.MovInstruction Dir, A
	"000000000110000100000000000000010",	-- instrucción 113 - Assembler.MovInstruction A, Lit
	"000000000011100000000000000000110",	-- instrucción 114 - Assembler.MovInstruction Dir, A
	"000000000101000000000000000000010",	-- instrucción 115 - Assembler.MovInstruction A, Lit
	"000000000011100100000000000000110",	-- instrucción 116 - Assembler.MovInstruction Dir, A
	"000000000110100100000000000000010",	-- instrucción 117 - Assembler.MovInstruction A, Lit
	"000000000011101000000000000000110",	-- instrucción 118 - Assembler.MovInstruction Dir, A
	"000000000110010100000000000000010",	-- instrucción 119 - Assembler.MovInstruction A, Lit
	"000000000011101100000000000000110",	-- instrucción 120 - Assembler.MovInstruction Dir, A
	"000000000111001000000000000000010",	-- instrucción 121 - Assembler.MovInstruction A, Lit
	"000000000011110000000000000000110",	-- instrucción 122 - Assembler.MovInstruction Dir, A
	"000000000110010000000000000000010",	-- instrucción 123 - Assembler.MovInstruction A, Lit
	"000000000011110100000000000000110",	-- instrucción 124 - Assembler.MovInstruction Dir, A
	"000000000110010100000000000000010",	-- instrucción 125 - Assembler.MovInstruction A, Lit
	"000000000011111000000000000000110",	-- instrucción 126 - Assembler.MovInstruction Dir, A
	"000000000110001100000000000000010",	-- instrucción 127 - Assembler.MovInstruction A, Lit
	"000000000011111100000000000000110",	-- instrucción 128 - Assembler.MovInstruction Dir, A
	"000000000110111100000000000000010",	-- instrucción 129 - Assembler.MovInstruction A, Lit
	"000000000100000000000000000000110",	-- instrucción 130 - Assembler.MovInstruction Dir, A
	"000000000110111000000000000000010",	-- instrucción 131 - Assembler.MovInstruction A, Lit
	"000000000100000100000000000000110",	-- instrucción 132 - Assembler.MovInstruction Dir, A
	"000000000111010000000000000000010",	-- instrucción 133 - Assembler.MovInstruction A, Lit
	"000000000100001000000000000000110",	-- instrucción 134 - Assembler.MovInstruction Dir, A
	"000000000110100100000000000000010",	-- instrucción 135 - Assembler.MovInstruction A, Lit
	"000000000100001100000000000000110",	-- instrucción 136 - Assembler.MovInstruction Dir, A
	"000000000110111000000000000000010",	-- instrucción 137 - Assembler.MovInstruction A, Lit
	...
	"000000000110000100000000000000010",	-- instrucción 141 - Assembler.MovInstruction A, Lit
	"000000000100011000000000000000110",	-- instrucción 142 - Assembler.MovInstruction Dir, A
	"000000000111001000000000000000010",	-- instrucción 143 - Assembler.MovInstruction A, Lit
	"000000000100011100000000000000110",	-- instrucción 144 - Assembler.MovInstruction Dir, A
	"000000000010111000000000000000010",	-- instrucción 145 - Assembler.MovInstruction A, Lit
	...
	"000000000011111100000000000000010",	-- instrucción 151 - Assembler.MovInstruction A, Lit
	"000000000100101100000000000000110",	-- instrucción 152 - Assembler.MovInstruction Dir, A
	"000000000011101000000000000000010",	-- instrucción 153 - Assembler.MovInstruction A, Lit
	"000000000100110000000000000000110",	-- instrucción 154 - Assembler.MovInstruction Dir, A
	"000000000010111000000000000000010",	-- instrucción 155 - Assembler.MovInstruction A, Lit
	"000000000100110100000000000000110",	-- instrucción 156 - Assembler.MovInstruction Dir, A
	"000000000000000000000000000000010",	-- instrucción 157 - Assembler.MovInstruction A, Lit
	...
	"000000000011000000000000000000010",	-- instrucción 177 - Assembler.MovInstruction A, Lit
	...
	"000100010001000100000000000000010",	-- instrucción 181 - Assembler.MovInstruction A, Lit
	"000000000101101000000000000000110",	-- instrucción 182 - Assembler.MovInstruction Dir, A
	"000000000000000100000000000000010",	-- instrucción 183 - Assembler.MovInstruction A, Lit
	"000000000101101100000000000000110",	-- instrucción 184 - Assembler.MovInstruction Dir, A
	"000000000000001000000000000000011",	-- instrucción 185 - Assembler.MovInstruction B, Lit
	"000000101100100100000000001010010",	-- instrucción 186 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000001001110",	-- instrucción 187 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000000010",	-- instrucción 188 - Assembler.MovInstruction A, Lit
	"000000000101100000000000000000110",	-- instrucción 189 - Assembler.MovInstruction Dir, A
	"000000000101100100000000000000110",	-- instrucción 190 - Assembler.MovInstruction Dir, A
	"000000000000000100000000001100000",	-- instrucción 191 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 192 - Assembler.Instructions.Pop2Instruction A, None
	"000000001100010100000000001010010",	-- instrucción 193 - Assembler.Instructions.CallInstruction Lit, None
	"000000001111011000000000001010010",	-- instrucción 194 - Assembler.Instructions.CallInstruction Lit, None
	"000000010011110000000000001010010",	-- instrucción 195 - Assembler.Instructions.CallInstruction Lit, None
	"000000010101001000000000001010010",	-- instrucción 196 - Assembler.Instructions.CallInstruction Lit, None
	"000000011000011100000000001010111",	-- instrucción 197 - Assembler.Instructions.JmpInstruction Lit, None
	"000000101000000000000000001010010",	-- instrucción 198 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000000000010",	-- instrucción 199 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 200 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100111100000000000000010",	-- instrucción 201 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 202 - Assembler.Instructions.CallInstruction Lit, None
	"000000101000011100000000001010010",	-- instrucción 203 - Assembler.Instructions.CallInstruction Lit, None
	"000000011110000100000000001010010",	-- instrucción 204 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001001011",	-- instrucción 205 - Assembler.CmpInstruction A, Lit
	"000000001111010000000000001011000",	-- instrucción 206 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000001000000000001001011",	-- instrucción 207 - Assembler.CmpInstruction A, Lit
	"000000001110010100000000001011000",	-- instrucción 208 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000010000000000001001011",	-- instrucción 209 - Assembler.CmpInstruction A, Lit
	"000000001101101100000000001011000",	-- instrucción 210 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000100000000000001001011",	-- instrucción 211 - Assembler.CmpInstruction A, Lit
	"000000001101011000000000001011000",	-- instrucción 212 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000001000000000000001001011",	-- instrucción 213 - Assembler.CmpInstruction A, Lit
	"000000001110101000000000001011000",	-- instrucción 214 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000100111100000000000000010",	-- instrucción 215 - Assembler.MovInstruction A, Lit
	"000000000101011100000000000010000",	-- instrucción 216 - Assembler.AddInstruction A, Dir
	"000000000000000000000000000000001",	-- instrucción 217 - Assembler.MovInstruction B, A
	"000000000000000000000000001001000",	-- instrucción 218 - Assembler.IncInstruction DirB, Lit
	"000000001100010100000000001010111",	-- instrucción 219 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000100111100000000000000010",	-- instrucción 220 - Assembler.MovInstruction A, Lit
	"000000000101011100000000000010000",	-- instrucción 221 - Assembler.AddInstruction A, Dir
	"000000000000000000000000000000001",	-- instrucción 222 - Assembler.MovInstruction B, A
	"000000000000000000000000001001110",	-- instrucción 223 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000001000",	-- instrucción 224 - Assembler.MovInstruction A, DirB
	"000000000000000100000000001001001",	-- instrucción 225 - Assembler.Instructions.DecInstruction A, Lit
	"000000000000000000000000000001010",	-- instrucción 226 - Assembler.MovInstruction DirB, A
	"000000000000000100000000001100000",	-- instrucción 227 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 228 - Assembler.Instructions.Pop2Instruction A, None
	"000000001100010100000000001010111",	-- instrucción 229 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000101011100000000000000100",	-- instrucción 230 - Assembler.MovInstruction A, Dir
	"000000000000001100000000001001011",	-- instrucción 231 - Assembler.CmpInstruction A, Lit
	"000000001110100100000000001011000",	-- instrucción 232 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000101011100000000001000111",	-- instrucción 233 - Assembler.IncInstruction Dir, Lit
	"000000001100010100000000001010111",	-- instrucción 234 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000101011100000000000000100",	-- instrucción 235 - Assembler.MovInstruction A, Dir
	"000000000000000000000000001001011",	-- instrucción 236 - Assembler.CmpInstruction A, Lit
	"000000001111001100000000001011000",	-- instrucción 237 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000000000000000001001110",	-- instrucción 238 - Assembler.Instructions.PushInstruction A, None
	"000000000101011100000000000000100",	-- instrucción 239 - Assembler.MovInstruction A, Dir
	"000000000000000100000000001001001",	-- instrucción 240 - Assembler.Instructions.DecInstruction A, Lit
	"000000000101011100000000000000110",	-- instrucción 241 - Assembler.MovInstruction Dir, A
	"000000000000000100000000001100000",	-- instrucción 242 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 243 - Assembler.Instructions.Pop2Instruction A, None
	"000000001100010100000000001010111",	-- instrucción 244 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 245 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 246 - Assembler.Instructions.Ret2Instruction None, None
	"000000000001000000000000000000010",	-- instrucción 247 - Assembler.MovInstruction A, Lit
	"000000101000000000000000001010010",	-- instrucción 248 - Assembler.Instructions.CallInstruction Lit, None
	"000000101011100000000000001010010",	-- instrucción 249 - Assembler.Instructions.CallInstruction Lit, None
	"000000000101001100000000000000010",	-- instrucción 250 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 251 - Assembler.Instructions.CallInstruction Lit, None
	"000000101000011100000000001010010",	-- instrucción 252 - Assembler.Instructions.CallInstruction Lit, None
	"000000011110000100000000001010010",	-- instrucción 253 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001001011",	-- instrucción 254 - Assembler.CmpInstruction A, Lit
	"000000010010010100000000001011000",	-- instrucción 255 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000001000000000001001011",	-- instrucción 256 - Assembler.CmpInstruction A, Lit
	"000000010001011000000000001011000",	-- instrucción 257 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000010000000000001001011",	-- instrucción 258 - Assembler.CmpInstruction A, Lit
	"000000010000110000000000001011000",	-- instrucción 259 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000100000000000001001011",	-- instrucción 260 - Assembler.CmpInstruction A, Lit
	"000000010000011100000000001011000",	-- instrucción 261 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000001000000000000001001011",	-- instrucción 262 - Assembler.CmpInstruction A, Lit
	"000000010001101100000000001011000",	-- instrucción 263 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000101001100000000000000010",	-- instrucción 264 - Assembler.MovInstruction A, Lit
	"000000000101011100000000000010000",	-- instrucción 265 - Assembler.AddInstruction A, Dir
	"000000000000000000000000000000001",	-- instrucción 266 - Assembler.MovInstruction B, A
	"000000000000000000000000001001000",	-- instrucción 267 - Assembler.IncInstruction DirB, Lit
	"000000001111011000000000001010111",	-- instrucción 268 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000101001100000000000000010",	-- instrucción 269 - Assembler.MovInstruction A, Lit
	"000000000101011100000000000010000",	-- instrucción 270 - Assembler.AddInstruction A, Dir
	"000000000000000000000000000000001",	-- instrucción 271 - Assembler.MovInstruction B, A
	"000000000000000000000000001001110",	-- instrucción 272 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000001000",	-- instrucción 273 - Assembler.MovInstruction A, DirB
	"000000000000000100000000001001001",	-- instrucción 274 - Assembler.Instructions.DecInstruction A, Lit
	"000000000000000000000000000001010",	-- instrucción 275 - Assembler.MovInstruction DirB, A
	"000000000000000100000000001100000",	-- instrucción 276 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 277 - Assembler.Instructions.Pop2Instruction A, None
	"000000001111011000000000001010111",	-- instrucción 278 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000101011100000000000000100",	-- instrucción 279 - Assembler.MovInstruction A, Dir
	"000000000000001100000000001001011",	-- instrucción 280 - Assembler.CmpInstruction A, Lit
	"000000010001101000000000001011000",	-- instrucción 281 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000101011100000000001000111",	-- instrucción 282 - Assembler.IncInstruction Dir, Lit
	"000000001111011000000000001010111",	-- instrucción 283 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000101011100000000000000100",	-- instrucción 284 - Assembler.MovInstruction A, Dir
	"000000000000000000000000001001011",	-- instrucción 285 - Assembler.CmpInstruction A, Lit
	"000000010010010000000000001011000",	-- instrucción 286 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000000000000000001001110",	-- instrucción 287 - Assembler.Instructions.PushInstruction A, None
	"000000000101011100000000000000100",	-- instrucción 288 - Assembler.MovInstruction A, Dir
	"000000000000000100000000001001001",	-- instrucción 289 - Assembler.Instructions.DecInstruction A, Lit
	"000000000101011100000000000000110",	-- instrucción 290 - Assembler.MovInstruction Dir, A
	"000000000000000100000000001100000",	-- instrucción 291 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 292 - Assembler.Instructions.Pop2Instruction A, None
	"000000001111011000000000001010111",	-- instrucción 293 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 294 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 295 - Assembler.Instructions.Ret2Instruction None, None
	"000000101000000000000000001010010",	-- instrucción 296 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100111100000000000000010",	-- instrucción 297 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 298 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110000000000000000010",	-- instrucción 299 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 300 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110100000000000000010",	-- instrucción 301 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 302 - Assembler.Instructions.CallInstruction Lit, None
	"000000000101100000000000000000010",	-- instrucción 303 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 304 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110100000000000000010",	-- instrucción 305 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 306 - Assembler.Instructions.CallInstruction Lit, None
	"000000000101001100000000000000010",	-- instrucción 307 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 308 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110000000000000000010",	-- instrucción 309 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 310 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110100000000000000010",	-- instrucción 311 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 312 - Assembler.Instructions.CallInstruction Lit, None
	"000000000101100100000000000000010",	-- instrucción 313 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 314 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 315 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 316 - Assembler.Instructions.Ret2Instruction None, None
	"000000000010000000000000000000100",	-- instrucción 317 - Assembler.MovInstruction A, Dir
	"000000000000000000000000001001011",	-- instrucción 318 - Assembler.CmpInstruction A, Lit
	"000000010100000100000000001011000",	-- instrucción 319 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000101001100000000000000100",	-- instrucción 320 - Assembler.MovInstruction A, Dir
	"000000010100001000000000001010111",	-- instrucción 321 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000100111100000000000000100",	-- instrucción 322 - Assembler.MovInstruction A, Dir
	"000000101000011100000000001010010",	-- instrucción 323 - Assembler.Instructions.CallInstruction Lit, None
	"000000101011100000000000001010010",	-- instrucción 324 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110000000000000000010",	-- instrucción 325 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 326 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110100000000000000010",	-- instrucción 327 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 328 - Assembler.Instructions.CallInstruction Lit, None
	"000000000010000100000000000000010",	-- instrucción 329 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 330 - Assembler.Instructions.CallInstruction Lit, None
	"000000011110000100000000001010010",	-- instrucción 331 - Assembler.Instructions.CallInstruction Lit, None
	...
	"000000000100111000000000000000110",	-- instrucción 336 - Assembler.MovInstruction Dir, A
	"000000000000000100000000001100001",	-- instrucción 337 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 338 - Assembler.Instructions.Ret2Instruction None, None
	"000000000010000000000000000000100",	-- instrucción 339 - Assembler.MovInstruction A, Dir
	"000000000000000000000000001001011",	-- instrucción 340 - Assembler.CmpInstruction A, Lit
	"000000010101011100000000001011000",	-- instrucción 341 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000101001100000000000000100",	-- instrucción 342 - Assembler.MovInstruction A, Dir
	"000000010101100000000000001010111",	-- instrucción 343 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000100111100000000000000100",	-- instrucción 344 - Assembler.MovInstruction A, Dir
	"000000101000011100000000001010010",	-- instrucción 345 - Assembler.Instructions.CallInstruction Lit, None
	"000000101011100000000000001010010",	-- instrucción 346 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110000000000000000010",	-- instrucción 347 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 348 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110100000000000000010",	-- instrucción 349 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 350 - Assembler.Instructions.CallInstruction Lit, None
	"000000000010000100000000000000010",	-- instrucción 351 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 352 - Assembler.Instructions.CallInstruction Lit, None
	"000000011110000100000000001010010",	-- instrucción 353 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 354 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 355 - Assembler.Instructions.Ret2Instruction None, None
	"000000010110001100000000000000010",	-- instrucción 356 - Assembler.MovInstruction A, Lit
	"000000101000011100000000001010010",	-- instrucción 357 - Assembler.Instructions.CallInstruction Lit, None
	"000000011110000100000000001010010",	-- instrucción 358 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001001011",	-- instrucción 359 - Assembler.CmpInstruction A, Lit
	"000000011010000000000000001011000",	-- instrucción 360 - Assembler.Instructions.JeqInstruction Lit, None
	"000000001011101000000000001010111",	-- instrucción 361 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000010000000000000000000100",	-- instrucción 362 - Assembler.MovInstruction A, Dir
	"000000000000000000000000001001011",	-- instrucción 363 - Assembler.CmpInstruction A, Lit
	"000000010110111100000000001011000",	-- instrucción 364 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000101100100000000001000111",	-- instrucción 365 - Assembler.IncInstruction Dir, Lit
	"000000000101001100000000000000100",	-- instrucción 366 - Assembler.MovInstruction A, Dir
	"000000010111000100000000001010111",	-- instrucción 367 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000101100100000000001000111",	-- instrucción 368 - Assembler.IncInstruction Dir, Lit
	"000000000100111100000000000000100",	-- instrucción 369 - Assembler.MovInstruction A, Dir
	"000000101000011100000000001010010",	-- instrucción 370 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110100000000000000100",	-- instrucción 371 - Assembler.MovInstruction A, Dir
	"000000101011100000000000001010010",	-- instrucción 372 - Assembler.Instructions.CallInstruction Lit, None
	"000000000011010100000000000000100",	-- instrucción 373 - Assembler.MovInstruction A, Dir
	"000000101011100000000000001010010",	-- instrucción 374 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 375 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 376 - Assembler.Instructions.Ret2Instruction None, None
	"000000000010000000000000000000100",	-- instrucción 377 - Assembler.MovInstruction A, Dir
	"000000000000000000000000001001011",	-- instrucción 378 - Assembler.CmpInstruction A, Lit
	"000000010111111000000000001011000",	-- instrucción 379 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000101100000000000001000111",	-- instrucción 380 - Assembler.IncInstruction Dir, Lit
	"000000000101001100000000000000100",	-- instrucción 381 - Assembler.MovInstruction A, Dir
	"000000011000000000000000001010111",	-- instrucción 382 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000101100100000000001000111",	-- instrucción 383 - Assembler.IncInstruction Dir, Lit
	"000000000100111100000000000000100",	-- instrucción 384 - Assembler.MovInstruction A, Dir
	"000000101000011100000000001010010",	-- instrucción 385 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110100000000000000100",	-- instrucción 386 - Assembler.MovInstruction A, Dir
	"000000101011100000000000001010010",	-- instrucción 387 - Assembler.Instructions.CallInstruction Lit, None
	"000000000011100100000000000000100",	-- instrucción 388 - Assembler.MovInstruction A, Dir
	"000000101011100000000000001010010",	-- instrucción 389 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 390 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 391 - Assembler.Instructions.Ret2Instruction None, None
	"000000010010011100000000001010010",	-- instrucción 392 - Assembler.Instructions.CallInstruction Lit, None
	"000000101000011100000000001010010",	-- instrucción 393 - Assembler.Instructions.CallInstruction Lit, None
	"000000011000111100000000001010010",	-- instrucción 394 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100110100000000000000010",	-- instrucción 395 - Assembler.MovInstruction A, Lit
	"000000100110011100000000001010010",	-- instrucción 396 - Assembler.Instructions.CallInstruction Lit, None
	"000000000010111000000000000000010",	-- instrucción 397 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 398 - Assembler.Instructions.CallInstruction Lit, None
	"000000011010000000000000001010111",	-- instrucción 399 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000010000000000000000000010",	-- instrucción 400 - Assembler.MovInstruction A, Lit
	"000000000000000000000000001001011",	-- instrucción 401 - Assembler.CmpInstruction A, Lit
	"000000011001011000000000001011000",	-- instrucción 402 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000101001100000000000000010",	-- instrucción 403 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 404 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 405 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 406 - Assembler.Instructions.Ret2Instruction None, None
	"000000000100111100000000000000010",	-- instrucción 407 - Assembler.MovInstruction A, Lit
	"000000101011100000000000001010010",	-- instrucción 408 - Assembler.Instructions.CallInstruction Lit, None
	"000000011001101100000000001010010",	-- instrucción 409 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 410 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 411 - Assembler.Instructions.Ret2Instruction None, None
	"000000000010000000000000000000100",	-- instrucción 412 - Assembler.MovInstruction A, Dir
	"000000000000000000000000000111001",	-- instrucción 413 - Assembler.NotInstruction A, None
	"000000000010000000000000000000110",	-- instrucción 414 - Assembler.MovInstruction Dir, A
	...
	"000000011100100000000000001010010",	-- instrucción 417 - Assembler.Instructions.CallInstruction Lit, None
	"000000000101101000000000000000100",	-- instrucción 418 - Assembler.MovInstruction A, Dir
	"000000000000000000000000001001011",	-- instrucción 419 - Assembler.CmpInstruction A, Lit
	"000000010111100000000000001011000",	-- instrucción 420 - Assembler.Instructions.JeqInstruction Lit, None
	"000000011110000100000000001010010",	-- instrucción 421 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000000000001",	-- instrucción 422 - Assembler.MovInstruction B, A
	"000000000000000000000000001010100",	-- instrucción 423 - Assembler.Instructions.InInstruction A, Lit
	"000000000100111000000000001001100",	-- instrucción 424 - Assembler.CmpInstruction A, Dir
	"000000010110100100000000001011000",	-- instrucción 425 - Assembler.Instructions.JeqInstruction Lit, None
	"000000011101110000000000001010010",	-- instrucción 426 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001001011",	-- instrucción 427 - Assembler.CmpInstruction A, Lit
	"000000011011010000000000001011000",	-- instrucción 428 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000001000000000001001011",	-- instrucción 429 - Assembler.CmpInstruction A, Lit
	"000000011011100000000000001011000",	-- instrucción 430 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000010000000000001001011",	-- instrucción 431 - Assembler.CmpInstruction A, Lit
	"000000011011110000000000001011000",	-- instrucción 432 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000100000000000001001011",	-- instrucción 433 - Assembler.CmpInstruction A, Lit
	"000000011100000000000000001011000",	-- instrucción 434 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000001000000000000001001011",	-- instrucción 435 - Assembler.CmpInstruction A, Lit
	"000000011100010000000000001011000",	-- instrucción 436 - Assembler.Instructions.JeqInstruction Lit, None
	"000000011101110000000000001010010",	-- instrucción 437 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100111000000000000100010",	-- instrucción 438 - Assembler.AndInstruction A, Dir
	"000000011100111100000000001010010",	-- instrucción 439 - Assembler.Instructions.CallInstruction Lit, None
	"000000011010000000000000001010111",	-- instrucción 440 - Assembler.Instructions.JmpInstruction Lit, None
	"000000011101110000000000001010010",	-- instrucción 441 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100111000000000000010000",	-- instrucción 442 - Assembler.AddInstruction A, Dir
	"000000011100111100000000001010010",	-- instrucción 443 - Assembler.Instructions.CallInstruction Lit, None
	"000000011010000000000000001010111",	-- instrucción 444 - Assembler.Instructions.JmpInstruction Lit, None
	"000000011101110000000000001010010",	-- instrucción 445 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100111000000000000101011",	-- instrucción 446 - Assembler.OrInstruction A, Dir
	"000000011100111100000000001010010",	-- instrucción 447 - Assembler.Instructions.CallInstruction Lit, None
	"000000011010000000000000001010111",	-- instrucción 448 - Assembler.Instructions.JmpInstruction Lit, None
	"000000011101110000000000001010010",	-- instrucción 449 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100111000000000000110100",	-- instrucción 450 - Assembler.XorInstruction A, Dir
	"000000011100111100000000001010010",	-- instrucción 451 - Assembler.Instructions.CallInstruction Lit, None
	"000000011010000000000000001010111",	-- instrucción 452 - Assembler.Instructions.JmpInstruction Lit, None
	"000000011101110000000000001010010",	-- instrucción 453 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100111000000000000011001",	-- instrucción 454 - Assembler.SubInstruction A, Dir
	"000000011100111100000000001010010",	-- instrucción 455 - Assembler.Instructions.CallInstruction Lit, None
	"000000011010000000000000001010111",	-- instrucción 456 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000000000000001001110",	-- instrucción 457 - Assembler.Instructions.PushInstruction A, None
	"000000000101101000000000000000100",	-- instrucción 458 - Assembler.MovInstruction A, Dir
	"000000000000000100000000001100101",	-- instrucción 459 - Assembler.Instructions.OutInstruction A, Lit
	"000000000000000100000000001100000",	-- instrucción 460 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 461 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 462 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 463 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 464 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 465 - Assembler.Instructions.PushInstruction B, None
	"000000000101101000000000000000100",	-- instrucción 466 - Assembler.MovInstruction A, Dir
	"000000000101101100000000000000101",	-- instrucción 467 - Assembler.MovInstruction B, Dir
	"000000000000000000000000000010101",	-- instrucción 468 - Assembler.SubInstruction A, B
	"000000000101101000000000000000110",	-- instrucción 469 - Assembler.MovInstruction Dir, A
	"000000000000000000000000000000000",	-- instrucción 470 - Assembler.MovInstruction A, B
	"000000000000000000000000000001100",	-- instrucción 471 - Assembler.AddInstruction A, B
	"000000000101101100000000000000110",	-- instrucción 472 - Assembler.MovInstruction Dir, A
	"000000000000000100000000001100000",	-- instrucción 473 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 474 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100000",	-- instrucción 475 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 476 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000000000000000110000",	-- instrucción 477 - Assembler.XorInstruction A, B
	"000000000000000000000000000110001",	-- instrucción 478 - Assembler.XorInstruction B, A
	"000000000000000000000000000110000",	-- instrucción 479 - Assembler.XorInstruction A, B
	"000000000000000100000000001100001",	-- instrucción 480 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 481 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001111",	-- instrucción 482 - Assembler.Instructions.PushInstruction B, None
	"000000000000000100000000001010100",	-- instrucción 483 - Assembler.Instructions.InInstruction A, Lit
	"000000000000000100000000001010101",	-- instrucción 484 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 485 - Assembler.CmpInstruction A, B
	"000000011110001100000000001011000",	-- instrucción 486 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000000000000000000110001",	-- instrucción 487 - Assembler.XorInstruction B, A
	"000000000000000100000000001010100",	-- instrucción 488 - Assembler.Instructions.InInstruction A, Lit
	"000000000000000000000000000011110",	-- instrucción 489 - Assembler.AndInstruction A, B
	"000000000000000000000000001001011",	-- instrucción 490 - Assembler.CmpInstruction A, Lit
	"000000011110011100000000001011001",	-- instrucción 491 - Assembler.Instructions.JneInstruction Lit, None
	"000000000000000000000000000000000",	-- instrucción 492 - Assembler.MovInstruction A, B
	"000000000000000100000000001100000",	-- instrucción 493 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 494 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100001",	-- instrucción 495 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 496 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001111",	-- instrucción 497 - Assembler.Instructions.PushInstruction B, None
	"000000000000001000000000001010101",	-- instrucción 498 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 499 - Assembler.CmpInstruction A, B
	"000000011111000100000000001011010",	-- instrucción 500 - Assembler.Instructions.JgtInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 501 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 502 - Assembler.Instructions.Pop2Instruction B, None
	"000000011111101000000000001010111",	-- instrucción 503 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000000000000000000001",	-- instrucción 504 - Assembler.MovInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 505 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 506 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000000000000001001111",	-- instrucción 507 - Assembler.Instructions.PushInstruction B, None
	"000000000000001000000000001010101",	-- instrucción 508 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 509 - Assembler.CmpInstruction A, B
	"000000100000101000000000001011001",	-- instrucción 510 - Assembler.Instructions.JneInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 511 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 512 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000000000000001001110",	-- instrucción 513 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000000000",	-- instrucción 514 - Assembler.MovInstruction A, B
	"000000000000001100000000001010101",	-- instrucción 515 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 516 - Assembler.CmpInstruction A, B
	"000000011111011100000000001011010",	-- instrucción 517 - Assembler.Instructions.JgtInstruction Lit, None
	"000000000000000000000000000000001",	-- instrucción 518 - Assembler.MovInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 519 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 520 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 521 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 522 - Assembler.Instructions.Ret2Instruction None, None
	...
	"000000000000000000000000001001110",	-- instrucción 527 - Assembler.Instructions.PushInstruction A, None
	"000000100001001100000000001010111",	-- instrucción 528 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000000000000000000001",	-- instrucción 529 - Assembler.MovInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 530 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 531 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000000000000001001111",	-- instrucción 532 - Assembler.Instructions.PushInstruction B, None
	"000000000000001100000000001010101",	-- instrucción 533 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 534 - Assembler.CmpInstruction A, B
	"000000100010010100000000001011001",	-- instrucción 535 - Assembler.Instructions.JneInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 536 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 537 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000000000000001001110",	-- instrucción 538 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000000000",	-- instrucción 539 - Assembler.MovInstruction A, B
	"000000000000010000000000001010101",	-- instrucción 540 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 541 - Assembler.CmpInstruction A, B
	"000000100001000000000000001011010",	-- instrucción 542 - Assembler.Instructions.JgtInstruction Lit, None
	"000000000000000000000000000000001",	-- instrucción 543 - Assembler.MovInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 544 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 545 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100000",	-- instrucción 546 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 547 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 548 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 549 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000100000000001100000",	-- instrucción 550 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 551 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100000",	-- instrucción 552 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 553 - Assembler.Instructions.Pop2Instruction A, None
	...
	"000000000000000000000000001001110",	-- instrucción 556 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 557 - Assembler.Instructions.PushInstruction B, None
	"000000000000001100000000001010101",	-- instrucción 558 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000000001100",	-- instrucción 559 - Assembler.AddInstruction A, B
	"000000000000001000000000001010101",	-- instrucción 560 - Assembler.Instructions.InInstruction B, Lit
	"000000111110100000000000001001011",	-- instrucción 561 - Assembler.CmpInstruction A, Lit
	"000000100011010100000000001011100",	-- instrucción 562 - Assembler.Instructions.JltInstruction Lit, None
	"000000111110100000000000000010111",	-- instrucción 563 - Assembler.SubInstruction A, Lit
	"000000000000000000000000001000110",	-- instrucción 564 - Assembler.IncInstruction B, Lit
	"000000100011000000000000001010111",	-- instrucción 565 - Assembler.Instructions.JmpInstruction Lit, None
	"000000011101110000000000001010010",	-- instrucción 566 - Assembler.Instructions.CallInstruction Lit, None
	"000000011111000000000000001010010",	-- instrucción 567 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 568 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 569 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100000",	-- instrucción 570 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 571 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 572 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 573 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 574 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 575 - Assembler.Instructions.PushInstruction B, None
	"000000000000010000000000001010101",	-- instrucción 576 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000000001100",	-- instrucción 577 - Assembler.AddInstruction A, B
	"000000000000000100000000001000101",	-- instrucción 578 - Assembler.IncInstruction A, Lit
	"000000000000000000000000000000011",	-- instrucción 579 - Assembler.MovInstruction B, Lit
	"000000111110100000000000001001011",	-- instrucción 580 - Assembler.CmpInstruction A, Lit
	"000000100100100000000000001011100",	-- instrucción 581 - Assembler.Instructions.JltInstruction Lit, None
	"000000111110100000000000000010111",	-- instrucción 582 - Assembler.SubInstruction A, Lit
	"000000000000000000000000001000110",	-- instrucción 583 - Assembler.IncInstruction B, Lit
	"000000100100001100000000001010111",	-- instrucción 584 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000000000000001001011",	-- instrucción 585 - Assembler.CmpInstruction A, Lit
	"000000100100101100000000001011000",	-- instrucción 586 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000000100000000001001001",	-- instrucción 587 - Assembler.Instructions.DecInstruction A, Lit
	"000000000000000000000000001001110",	-- instrucción 588 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 589 - Assembler.Instructions.PushInstruction B, None
	"000000000000001100000000001010100",	-- instrucción 590 - Assembler.Instructions.InInstruction A, Lit
	"000000000000000000000000000001101",	-- instrucción 591 - Assembler.AddInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 592 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 593 - Assembler.Instructions.Pop2Instruction A, None
	"000000100010101100000000001010010",	-- instrucción 594 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000000000000",	-- instrucción 595 - Assembler.MovInstruction A, B
	"000000111110100000000000001001011",	-- instrucción 596 - Assembler.CmpInstruction A, Lit
	"000000100101011000000000001011100",	-- instrucción 597 - Assembler.Instructions.JltInstruction Lit, None
	"000000111110100000000000000010111",	-- instrucción 598 - Assembler.SubInstruction A, Lit
	"000000000000000100000000001100000",	-- instrucción 599 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 600 - Assembler.Instructions.Pop2Instruction B, None
	"000000100000111000000000001010010",	-- instrucción 601 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 602 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 603 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100000",	-- instrucción 604 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 605 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 606 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 607 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 608 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001100010",	-- instrucción 609 - Assembler.Instructions.OutInstruction A, B
	"000000000010011100000000000000010",	-- instrucción 610 - Assembler.MovInstruction A, Lit
	"000000100011110100000000001010010",	-- instrucción 611 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 612 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 613 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 614 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 615 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 616 - Assembler.Instructions.PushInstruction A, None
	"000000100000000000000000000101001",	-- instrucción 617 - Assembler.OrInstruction A, Lit
	"000000100101111100000000001010010",	-- instrucción 618 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 619 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 620 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 621 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 622 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 623 - Assembler.Instructions.PushInstruction A, None
	"000000000000000100000000000000010",	-- instrucción 624 - Assembler.MovInstruction A, Lit
	"000000100101111100000000001010010",	-- instrucción 625 - Assembler.Instructions.CallInstruction Lit, None
	"000001011111101000000000000000010",	-- instrucción 626 - Assembler.MovInstruction A, Lit
	"000000100011110100000000001010010",	-- instrucción 627 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 628 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 629 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 630 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 631 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 632 - Assembler.Instructions.PushInstruction A, None
	"000000000000001000000000000000010",	-- instrucción 633 - Assembler.MovInstruction A, Lit
	"000000100101111100000000001010010",	-- instrucción 634 - Assembler.Instructions.CallInstruction Lit, None
	"000001011111101000000000000000010",	-- instrucción 635 - Assembler.MovInstruction A, Lit
	"000000100011110100000000001010010",	-- instrucción 636 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 637 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 638 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 639 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 640 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 641 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000000010",	-- instrucción 642 - Assembler.MovInstruction A, Lit
	"000000101000111000000000001010010",	-- instrucción 643 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 644 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 645 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 646 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 647 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 648 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000000010",	-- instrucción 649 - Assembler.MovInstruction A, Lit
	"000000101001010100000000001010010",	-- instrucción 650 - Assembler.Instructions.CallInstruction Lit, None
	...
	"000000000000000100000000001100001",	-- instrucción 653 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 654 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 655 - Assembler.Instructions.PushInstruction A, None
	"000000001000000000000000000101001",	-- instrucción 656 - Assembler.OrInstruction A, Lit
	"000000100101111100000000001010010",	-- instrucción 657 - Assembler.Instructions.CallInstruction Lit, None
	...
	"000000001100000000000000000101001",	-- instrucción 663 - Assembler.OrInstruction A, Lit
	"000000100101111100000000001010010",	-- instrucción 664 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 665 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 666 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 667 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 668 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 669 - Assembler.Instructions.PushInstruction A, None
	"000000000001100000000000000000010",	-- instrucción 670 - Assembler.MovInstruction A, Lit
	"000000100101111100000000001010010",	-- instrucción 671 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 672 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 673 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 674 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 675 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 676 - Assembler.Instructions.PushInstruction A, None
	"000000000001110000000000000000010",	-- instrucción 677 - Assembler.MovInstruction A, Lit
	"000000100101111100000000001010010",	-- instrucción 678 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 679 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 680 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 681 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 682 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 683 - Assembler.Instructions.PushInstruction A, None
	"000000000001000000000000000000010",	-- instrucción 684 - Assembler.MovInstruction A, Lit
	"000000100101111100000000001010010",	-- instrucción 685 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 686 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 687 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 688 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 689 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 690 - Assembler.Instructions.PushInstruction A, None
	"000000000001010000000000000000010",	-- instrucción 691 - Assembler.MovInstruction A, Lit
	"000000100101111100000000001010010",	-- instrucción 692 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 693 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 694 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 695 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 696 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 697 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 698 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000000000001",	-- instrucción 699 - Assembler.MovInstruction B, A
	"000000000000000000000000000001000",	-- instrucción 700 - Assembler.MovInstruction A, DirB
	"000000000000000100000000001100000",	-- instrucción 701 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 702 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000000000000001001011",	-- instrucción 703 - Assembler.CmpInstruction A, Lit
	"000000101100010100000000001011000",	-- instrucción 704 - Assembler.Instructions.JeqInstruction Lit, None
	"000000100110011100000000001010010",	-- instrucción 705 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 706 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 707 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001000101",	-- instrucción 708 - Assembler.IncInstruction A, Lit
	"000000101011100000000000001010111",	-- instrucción 709 - Assembler.Instructions.JmpInstruction Lit, None
	...
	"000000000001111000000000000000010",	-- instrucción 715 - Assembler.MovInstruction A, Lit
	"000000100010101100000000001010010",	-- instrucción 716 - Assembler.Instructions.CallInstruction Lit, None
	"000000000011110000000000000000010",	-- instrucción 717 - Assembler.MovInstruction A, Lit
	"000000100101111100000000001010010",	-- instrucción 718 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000111100000000000000010",	-- instrucción 719 - Assembler.MovInstruction A, Lit
	"000000100101111100000000001010010",	-- instrucción 720 - Assembler.Instructions.CallInstruction Lit, None
	"000000100110111000000000001010010",	-- instrucción 721 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000011000000000000000010",	-- instrucción 722 - Assembler.MovInstruction A, Lit
	"000000100101111100000000001010010",	-- instrucción 723 - Assembler.Instructions.CallInstruction Lit, None
	"000000100111011100000000001010010",	-- instrucción 724 - Assembler.Instructions.CallInstruction Lit, None
	...
	"000000000000000000000000001011111",	-- instrucción 729
	"000000000000000000000000001011111",	-- instrucción 730
	"000000000000000000000000001011111",	-- instrucción 731
	"000000000000000000000000001011111",	-- instrucción 732
	"000000000000000000000000001011111",	-- instrucción 733
	"000000000000000000000000001011111",	-- instrucción 734
	"000000000000000000000000001011111",	-- instrucción 735
	"000000000000000000000000001011111",	-- instrucción 736
	"000000000000000000000000001011111",	-- instrucción 737
	"000000000000000000000000001011111",	-- instrucción 738
	"000000000000000000000000001011111",	-- instrucción 739
	"000000000000000000000000001011111",	-- instrucción 740
	"000000000000000000000000001011111",	-- instrucción 741
	"000000000000000000000000001011111",	-- instrucción 742
	"000000000000000000000000001011111",	-- instrucción 743
	"000000000000000000000000001011111",	-- instrucción 744
	"000000000000000000000000001011111",	-- instrucción 745
	"000000000000000000000000001011111",	-- instrucción 746
	"000000000000000000000000001011111",	-- instrucción 747
	"000000000000000000000000001011111",	-- instrucción 748
	"000000000000000000000000001011111",	-- instrucción 749
	"000000000000000000000000001011111",	-- instrucción 750
	"000000000000000000000000001011111",	-- instrucción 751
	"000000000000000000000000001011111",	-- instrucción 752
	"000000000000000000000000001011111",	-- instrucción 753
	"000000000000000000000000001011111",	-- instrucción 754
	"000000000000000000000000001011111",	-- instrucción 755
	"000000000000000000000000001011111",	-- instrucción 756
	"000000000000000000000000001011111",	-- instrucción 757
	"000000000000000000000000001011111",	-- instrucción 758
	"000000000000000000000000001011111",	-- instrucción 759
	"000000000000000000000000001011111",	-- instrucción 760
