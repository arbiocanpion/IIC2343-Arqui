...
signal memory : memory_array:= (
	"000000000110011000000000000000010",	-- instrucción 1 - Assembler.MovInstruction A, Lit
	"000000000000000000000000000000110",	-- instrucción 2 - Assembler.MovInstruction Dir, A
	"000000000110110000000000000000010",	-- instrucción 3 - Assembler.MovInstruction A, Lit
	"000000000000000100000000000000110",	-- instrucción 4 - Assembler.MovInstruction Dir, A
	"000000000111010100000000000000010",	-- instrucción 5 - Assembler.MovInstruction A, Lit
	"000000000000001000000000000000110",	-- instrucción 6 - Assembler.MovInstruction Dir, A
	"000000000110001100000000000000010",	-- instrucción 7 - Assembler.MovInstruction A, Lit
	"000000000000001100000000000000110",	-- instrucción 8 - Assembler.MovInstruction Dir, A
	"000000000110001100000000000000010",	-- instrucción 9 - Assembler.MovInstruction A, Lit
	"000000000000010000000000000000110",	-- instrucción 10 - Assembler.MovInstruction Dir, A
	"000000000110100000000000000000010",	-- instrucción 11 - Assembler.MovInstruction A, Lit
	"000000000000010100000000000000110",	-- instrucción 12 - Assembler.MovInstruction Dir, A
	"000000000110100100000000000000010",	-- instrucción 13 - Assembler.MovInstruction A, Lit
	"000000000000011000000000000000110",	-- instrucción 14 - Assembler.MovInstruction Dir, A
	"000000000110111000000000000000010",	-- instrucción 15 - Assembler.MovInstruction A, Lit
	...
	"000000000111010100000000000000010",	-- instrucción 19 - Assembler.MovInstruction A, Lit
	"000000000000100100000000000000110",	-- instrucción 20 - Assembler.MovInstruction Dir, A
	"000000000110001100000000000000010",	-- instrucción 21 - Assembler.MovInstruction A, Lit
	"000000000000101000000000000000110",	-- instrucción 22 - Assembler.MovInstruction Dir, A
	"000000000010111000000000000000010",	-- instrucción 23 - Assembler.MovInstruction A, Lit
	"000000000000101100000000000000110",	-- instrucción 24 - Assembler.MovInstruction Dir, A
	"000000000110001100000000000000010",	-- instrucción 25 - Assembler.MovInstruction A, Lit
	"000000000000110000000000000000110",	-- instrucción 26 - Assembler.MovInstruction Dir, A
	"000000000110110000000000000000010",	-- instrucción 27 - Assembler.MovInstruction A, Lit
	"000000000000110100000000000000110",	-- instrucción 28 - Assembler.MovInstruction Dir, A
	"000000000000001000000000000000011",	-- instrucción 29 - Assembler.MovInstruction B, Lit
	"000000010001001000000000001010010",	-- instrucción 30 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000000000010",	-- instrucción 31 - Assembler.MovInstruction A, Lit
	"000000010000000100000000001010010",	-- instrucción 32 - Assembler.Instructions.CallInstruction Lit, None
	"000000000100000000000000000000010",	-- instrucción 33 - Assembler.MovInstruction A, Lit
	"000000001011000000000000001010010",	-- instrucción 34 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000100100000000000000010",	-- instrucción 35 - Assembler.MovInstruction A, Lit
	"000000010000000100000000001010010",	-- instrucción 36 - Assembler.Instructions.CallInstruction Lit, None
	"000000000010010000000000001010111",	-- instrucción 37 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000000000000000110000",	-- instrucción 38 - Assembler.XorInstruction A, B
	"000000000000000000000000000110001",	-- instrucción 39 - Assembler.XorInstruction B, A
	"000000000000000000000000000110000",	-- instrucción 40 - Assembler.XorInstruction A, B
	"000000000000000100000000001100001",	-- instrucción 41 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 42 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001111",	-- instrucción 43 - Assembler.Instructions.PushInstruction B, None
	"000000000000000100000000001010100",	-- instrucción 44 - Assembler.Instructions.InInstruction A, Lit
	"000000000000000100000000001010101",	-- instrucción 45 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 46 - Assembler.CmpInstruction A, B
	"000000000010110000000000001011000",	-- instrucción 47 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000000000000000000110001",	-- instrucción 48 - Assembler.XorInstruction B, A
	"000000000000000100000000001010100",	-- instrucción 49 - Assembler.Instructions.InInstruction A, Lit
	"000000000000000000000000000011110",	-- instrucción 50 - Assembler.AndInstruction A, B
	"000000000000000000000000001001011",	-- instrucción 51 - Assembler.CmpInstruction A, Lit
	"000000000011000000000000001011001",	-- instrucción 52 - Assembler.Instructions.JneInstruction Lit, None
	"000000000000000000000000000000000",	-- instrucción 53 - Assembler.MovInstruction A, B
	"000000000000000100000000001100000",	-- instrucción 54 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 55 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100001",	-- instrucción 56 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 57 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001111",	-- instrucción 58 - Assembler.Instructions.PushInstruction B, None
	"000000000000001000000000001010101",	-- instrucción 59 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 60 - Assembler.CmpInstruction A, B
	"000000000011101000000000001011010",	-- instrucción 61 - Assembler.Instructions.JgtInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 62 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 63 - Assembler.Instructions.Pop2Instruction B, None
	"000000000100001100000000001010111",	-- instrucción 64 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000000000000000000001",	-- instrucción 65 - Assembler.MovInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 66 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 67 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000000000000001001111",	-- instrucción 68 - Assembler.Instructions.PushInstruction B, None
	"000000000000001000000000001010101",	-- instrucción 69 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 70 - Assembler.CmpInstruction A, B
	"000000000101001100000000001011001",	-- instrucción 71 - Assembler.Instructions.JneInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 72 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 73 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000000000000001001110",	-- instrucción 74 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000000000",	-- instrucción 75 - Assembler.MovInstruction A, B
	"000000000000001100000000001010101",	-- instrucción 76 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 77 - Assembler.CmpInstruction A, B
	"000000000100000000000000001011010",	-- instrucción 78 - Assembler.Instructions.JgtInstruction Lit, None
	"000000000000000000000000000000001",	-- instrucción 79 - Assembler.MovInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 80 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 81 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 82 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 83 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000100000000001100000",	-- instrucción 84 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 85 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100001",	-- instrucción 86 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 87 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 88 - Assembler.Instructions.PushInstruction A, None
	"000000000101110000000000001010111",	-- instrucción 89 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000000000000000000001",	-- instrucción 90 - Assembler.MovInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 91 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 92 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000000000000001001111",	-- instrucción 93 - Assembler.Instructions.PushInstruction B, None
	"000000000000001100000000001010101",	-- instrucción 94 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 95 - Assembler.CmpInstruction A, B
	"000000000110111000000000001011001",	-- instrucción 96 - Assembler.Instructions.JneInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 97 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 98 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000000000000001001110",	-- instrucción 99 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000000000",	-- instrucción 100 - Assembler.MovInstruction A, B
	"000000000000010000000000001010101",	-- instrucción 101 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000001001010",	-- instrucción 102 - Assembler.CmpInstruction A, B
	"000000000101100100000000001011010",	-- instrucción 103 - Assembler.Instructions.JgtInstruction Lit, None
	"000000000000000000000000000000001",	-- instrucción 104 - Assembler.MovInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 105 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 106 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100000",	-- instrucción 107 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 108 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 109 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 110 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000100000000001100000",	-- instrucción 111 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 112 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100000",	-- instrucción 113 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 114 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 115 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 116 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 117 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 118 - Assembler.Instructions.PushInstruction B, None
	"000000000000001100000000001010101",	-- instrucción 119 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000000001100",	-- instrucción 120 - Assembler.AddInstruction A, B
	"000000000000001000000000001010101",	-- instrucción 121 - Assembler.Instructions.InInstruction B, Lit
	"000000111110100000000000001001011",	-- instrucción 122 - Assembler.CmpInstruction A, Lit
	"000000000111111000000000001011100",	-- instrucción 123 - Assembler.Instructions.JltInstruction Lit, None
	"000000111110100000000000000010111",	-- instrucción 124 - Assembler.SubInstruction A, Lit
	"000000000000000000000000001000110",	-- instrucción 125 - Assembler.IncInstruction B, Lit
	"000000000111100100000000001010111",	-- instrucción 126 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000010010100000000001010010",	-- instrucción 127 - Assembler.Instructions.CallInstruction Lit, None
	"000000000011100100000000001010010",	-- instrucción 128 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 129 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 130 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100000",	-- instrucción 131 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 132 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 133 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 134 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 135 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 136 - Assembler.Instructions.PushInstruction B, None
	"000000000000010000000000001010101",	-- instrucción 137 - Assembler.Instructions.InInstruction B, Lit
	"000000000000000000000000000001100",	-- instrucción 138 - Assembler.AddInstruction A, B
	"000000000000000100000000001000101",	-- instrucción 139 - Assembler.IncInstruction A, Lit
	"000000000000000000000000000000011",	-- instrucción 140 - Assembler.MovInstruction B, Lit
	"000000111110100000000000001001011",	-- instrucción 141 - Assembler.CmpInstruction A, Lit
	"000000001001000100000000001011100",	-- instrucción 142 - Assembler.Instructions.JltInstruction Lit, None
	"000000111110100000000000000010111",	-- instrucción 143 - Assembler.SubInstruction A, Lit
	"000000000000000000000000001000110",	-- instrucción 144 - Assembler.IncInstruction B, Lit
	"000000001000110000000000001010111",	-- instrucción 145 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000000000000001001011",	-- instrucción 146 - Assembler.CmpInstruction A, Lit
	"000000001001010000000000001011000",	-- instrucción 147 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000000100000000001001001",	-- instrucción 148 - Assembler.Instructions.DecInstruction A, Lit
	"000000000000000000000000001001110",	-- instrucción 149 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 150 - Assembler.Instructions.PushInstruction B, None
	"000000000000001100000000001010100",	-- instrucción 151 - Assembler.Instructions.InInstruction A, Lit
	"000000000000000000000000000001101",	-- instrucción 152 - Assembler.AddInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 153 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 154 - Assembler.Instructions.Pop2Instruction A, None
	"000000000111010000000000001010010",	-- instrucción 155 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000000000000",	-- instrucción 156 - Assembler.MovInstruction A, B
	"000000111110100000000000001001011",	-- instrucción 157 - Assembler.CmpInstruction A, Lit
	"000000001001111100000000001011100",	-- instrucción 158 - Assembler.Instructions.JltInstruction Lit, None
	"000000111110100000000000000010111",	-- instrucción 159 - Assembler.SubInstruction A, Lit
	"000000000000000100000000001100000",	-- instrucción 160 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 161 - Assembler.Instructions.Pop2Instruction B, None
	"000000000101011100000000001010010",	-- instrucción 162 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 163 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 164 - Assembler.Instructions.Pop2Instruction B, None
	...
	"000000000000000100000000001100001",	-- instrucción 167 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 168 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 169 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001100010",	-- instrucción 170 - Assembler.Instructions.OutInstruction A, B
	"000000000010011100000000000000010",	-- instrucción 171 - Assembler.MovInstruction A, Lit
	"000000001000011000000000001010010",	-- instrucción 172 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 173 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 174 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 175 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 176 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 177 - Assembler.Instructions.PushInstruction A, None
	"000000100000000000000000000101001",	-- instrucción 178 - Assembler.OrInstruction A, Lit
	"000000001010100000000000001010010",	-- instrucción 179 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 180 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 181 - Assembler.Instructions.Pop2Instruction A, None
	...
	"000000000000000000000000001001110",	-- instrucción 184 - Assembler.Instructions.PushInstruction A, None
	"000000000000000100000000000000010",	-- instrucción 185 - Assembler.MovInstruction A, Lit
	"000000001010100000000000001010010",	-- instrucción 186 - Assembler.Instructions.CallInstruction Lit, None
	"000001011111101000000000000000010",	-- instrucción 187 - Assembler.MovInstruction A, Lit
	"000000001000011000000000001010010",	-- instrucción 188 - Assembler.Instructions.CallInstruction Lit, None
	...
	"000000000000000100000000001100001",	-- instrucción 191 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 192 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 193 - Assembler.Instructions.PushInstruction A, None
	"000000000000001000000000000000010",	-- instrucción 194 - Assembler.MovInstruction A, Lit
	"000000001010100000000000001010010",	-- instrucción 195 - Assembler.Instructions.CallInstruction Lit, None
	"000001011111101000000000000000010",	-- instrucción 196 - Assembler.MovInstruction A, Lit
	"000000001000011000000000001010010",	-- instrucción 197 - Assembler.Instructions.CallInstruction Lit, None
	...
	"000000000000000100000000001100001",	-- instrucción 200 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 201 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 202 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000000010",	-- instrucción 203 - Assembler.MovInstruction A, Lit
	"000000001101011100000000001010010",	-- instrucción 204 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 205 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 206 - Assembler.Instructions.Pop2Instruction A, None
	...
	"000000000000000000000000001001110",	-- instrucción 209 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000000010",	-- instrucción 210 - Assembler.MovInstruction A, Lit
	"000000001101111000000000001010010",	-- instrucción 211 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 212 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 213 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 214 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 215 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 216 - Assembler.Instructions.PushInstruction A, None
	"000000001000000000000000000101001",	-- instrucción 217 - Assembler.OrInstruction A, Lit
	"000000001010100000000000001010010",	-- instrucción 218 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 219 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 220 - Assembler.Instructions.Pop2Instruction A, None
	...
	"000000001100000000000000000101001",	-- instrucción 224 - Assembler.OrInstruction A, Lit
	"000000001010100000000000001010010",	-- instrucción 225 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 226 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 227 - Assembler.Instructions.Pop2Instruction A, None
	...
	"000000000000000000000000001001110",	-- instrucción 230 - Assembler.Instructions.PushInstruction A, None
	"000000000001100000000000000000010",	-- instrucción 231 - Assembler.MovInstruction A, Lit
	"000000001010100000000000001010010",	-- instrucción 232 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 233 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 234 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 235 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 236 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 237 - Assembler.Instructions.PushInstruction A, None
	"000000000001110000000000000000010",	-- instrucción 238 - Assembler.MovInstruction A, Lit
	"000000001010100000000000001010010",	-- instrucción 239 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 240 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 241 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 242 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 243 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 244 - Assembler.Instructions.PushInstruction A, None
	"000000000001000000000000000000010",	-- instrucción 245 - Assembler.MovInstruction A, Lit
	"000000001010100000000000001010010",	-- instrucción 246 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 247 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 248 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 249 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 250 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 251 - Assembler.Instructions.PushInstruction A, None
	"000000000001010000000000000000010",	-- instrucción 252 - Assembler.MovInstruction A, Lit
	"000000001010100000000000001010010",	-- instrucción 253 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 254 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 255 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 256 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 257 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 258 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 259 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000000000001",	-- instrucción 260 - Assembler.MovInstruction B, A
	"000000000000000000000000000001000",	-- instrucción 261 - Assembler.MovInstruction A, DirB
	"000000000000000100000000001100000",	-- instrucción 262 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 263 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000000000000001001011",	-- instrucción 264 - Assembler.CmpInstruction A, Lit
	"000000010000111000000000001011000",	-- instrucción 265 - Assembler.Instructions.JeqInstruction Lit, None
	"000000001011000000000000001010010",	-- instrucción 266 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 267 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 268 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001000101",	-- instrucción 269 - Assembler.IncInstruction A, Lit
	"000000010000000100000000001010111",	-- instrucción 270 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 271 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 272 - Assembler.Instructions.Pop2Instruction A, None
	...
	"000000000001111000000000000000010",	-- instrucción 276 - Assembler.MovInstruction A, Lit
	"000000000111010000000000001010010",	-- instrucción 277 - Assembler.Instructions.CallInstruction Lit, None
	"000000000011010000000000000000010",	-- instrucción 278 - Assembler.MovInstruction A, Lit
	"000000001010100000000000001010010",	-- instrucción 279 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000111100000000000000010",	-- instrucción 280 - Assembler.MovInstruction A, Lit
	"000000001010100000000000001010010",	-- instrucción 281 - Assembler.Instructions.CallInstruction Lit, None
	"000000001011011100000000001010010",	-- instrucción 282 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000011000000000000000010",	-- instrucción 283 - Assembler.MovInstruction A, Lit
	"000000001010100000000000001010010",	-- instrucción 284 - Assembler.Instructions.CallInstruction Lit, None
	"000000001100000000000000001010010",	-- instrucción 285 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 286 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 287 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 288 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 289 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001011111",	-- instrucción 290
	"000000000000000000000000001011111",	-- instrucción 291
	"000000000000000000000000001011111",	-- instrucción 292
	"000000000000000000000000001011111",	-- instrucción 293
	"000000000000000000000000001011111",	-- instrucción 294
	"000000000000000000000000001011111",	-- instrucción 295
	"000000000000000000000000001011111",	-- instrucción 296
	"000000000000000000000000001011111",	-- instrucción 297
	"000000000000000000000000001011111",	-- instrucción 298
	"000000000000000000000000001011111",	-- instrucción 299
	"000000000000000000000000001011111",	-- instrucción 300
	"000000000000000000000000001011111",	-- instrucción 301
	"000000000000000000000000001011111",	-- instrucción 302
	"000000000000000000000000001011111",	-- instrucción 303
	"000000000000000000000000001011111",	-- instrucción 304
	"000000000000000000000000001011111",	-- instrucción 305
	"000000000000000000000000001011111",	-- instrucción 306
	"000000000000000000000000001011111",	-- instrucción 307
	"000000000000000000000000001011111",	-- instrucción 308
	"000000000000000000000000001011111",	-- instrucción 309
	"000000000000000000000000001011111",	-- instrucción 310
	"000000000000000000000000001011111",	-- instrucción 311
	"000000000000000000000000001011111",	-- instrucción 312
	"000000000000000000000000001011111",	-- instrucción 313
	"000000000000000000000000001011111",	-- instrucción 314
	"000000000000000000000000001011111",	-- instrucción 315
	"000000000000000000000000001011111",	-- instrucción 316
	"000000000000000000000000001011111",	-- instrucción 317
	"000000000000000000000000001011111",	-- instrucción 318
	"000000000000000000000000001011111",	-- instrucción 319
	"000000000000000000000000001011111",	-- instrucción 320
	"000000000000000000000000001011111",	-- instrucción 321
	"000000000000000000000000001011111",	-- instrucción 322
	"000000000000000000000000001011111",	-- instrucción 323
	"000000000000000000000000001011111",	-- instrucción 324
	"000000000000000000000000001011111",	-- instrucción 325
	"000000000000000000000000001011111",	-- instrucción 326
	"000000000000000000000000001011111",	-- instrucción 327
	"000000000000000000000000001011111",	-- instrucción 328
	"000000000000000000000000001011111",	-- instrucción 329
	"000000000000000000000000001011111",	-- instrucción 330
	"000000000000000000000000001011111",	-- instrucción 331
	"000000000000000000000000001011111",	-- instrucción 332
	"000000000000000000000000001011111",	-- instrucción 333
	"000000000000000000000000001011111",	-- instrucción 334
	"000000000000000000000000001011111",	-- instrucción 335
	"000000000000000000000000001011111",	-- instrucción 336
	"000000000000000000000000001011111",	-- instrucción 337
	"000000000000000000000000001011111",	-- instrucción 338
	"000000000000000000000000001011111",	-- instrucción 339
	"000000000000000000000000001011111",	-- instrucción 340
	"000000000000000000000000001011111",	-- instrucción 341
	"000000000000000000000000001011111",	-- instrucción 342
	"000000000000000000000000001011111",	-- instrucción 343
	"000000000000000000000000001011111",	-- instrucción 344
	"000000000000000000000000001011111",	-- instrucción 345
	"000000000000000000000000001011111",	-- instrucción 346
	"000000000000000000000000001011111",	-- instrucción 347
	"000000000000000000000000001011111",	-- instrucción 348
	"000000000000000000000000001011111",	-- instrucción 349
	"000000000000000000000000001011111",	-- instrucción 350
	"000000000000000000000000001011111",	-- instrucción 351
	"000000000000000000000000001011111",	-- instrucción 352
	"000000000000000000000000001011111",	-- instrucción 353
	"000000000000000000000000001011111",	-- instrucción 354
	"000000000000000000000000001011111",	-- instrucción 355
	"000000000000000000000000001011111",	-- instrucción 356
	"000000000000000000000000001011111",	-- instrucción 357
	"000000000000000000000000001011111",	-- instrucción 358
	"000000000000000000000000001011111",	-- instrucción 359
	"000000000000000000000000001011111",	-- instrucción 360
	"000000000000000000000000001011111",	-- instrucción 361
	"000000000000000000000000001011111",	-- instrucción 362
	"000000000000000000000000001011111",	-- instrucción 363
	"000000000000000000000000001011111",	-- instrucción 364
	"000000000000000000000000001011111",	-- instrucción 365
	"000000000000000000000000001011111",	-- instrucción 366
	"000000000000000000000000001011111",	-- instrucción 367
	"000000000000000000000000001011111",	-- instrucción 368
	"000000000000000000000000001011111",	-- instrucción 369
	"000000000000000000000000001011111",	-- instrucción 370
	"000000000000000000000000001011111",	-- instrucción 371
	"000000000000000000000000001011111",	-- instrucción 372
	"000000000000000000000000001011111",	-- instrucción 373
	"000000000000000000000000001011111",	-- instrucción 374
	"000000000000000000000000001011111",	-- instrucción 375
	"000000000000000000000000001011111",	-- instrucción 376
	"000000000000000000000000001011111",	-- instrucción 377
	"000000000000000000000000001011111",	-- instrucción 378
	"000000000000000000000000001011111",	-- instrucción 379
	"000000000000000000000000001011111",	-- instrucción 380
	"000000000000000000000000001011111",	-- instrucción 381
	"000000000000000000000000001011111",	-- instrucción 382
	"000000000000000000000000001011111",	-- instrucción 383
	"000000000000000000000000001011111",	-- instrucción 384
	"000000000000000000000000001011111",	-- instrucción 385
	"000000000000000000000000001011111",	-- instrucción 386
	"000000000000000000000000001011111",	-- instrucción 387
	"000000000000000000000000001011111",	-- instrucción 388
	"000000000000000000000000001011111",	-- instrucción 389
	"000000000000000000000000001011111",	-- instrucción 390
	"000000000000000000000000001011111",	-- instrucción 391
	"000000000000000000000000001011111",	-- instrucción 392
	"000000000000000000000000001011111",	-- instrucción 393
	"000000000000000000000000001011111",	-- instrucción 394
	"000000000000000000000000001011111",	-- instrucción 395
	"000000000000000000000000001011111",	-- instrucción 396
	"000000000000000000000000001011111",	-- instrucción 397
	"000000000000000000000000001011111",	-- instrucción 398
	"000000000000000000000000001011111",	-- instrucción 399
	"000000000000000000000000001011111",	-- instrucción 400
	"000000000000000000000000001011111",	-- instrucción 401
	"000000000000000000000000001011111",	-- instrucción 402
	"000000000000000000000000001011111",	-- instrucción 403
	"000000000000000000000000001011111",	-- instrucción 404
	"000000000000000000000000001011111",	-- instrucción 405
	"000000000000000000000000001011111",	-- instrucción 406
	"000000000000000000000000001011111",	-- instrucción 407
	"000000000000000000000000001011111",	-- instrucción 408
	"000000000000000000000000001011111",	-- instrucción 409
	"000000000000000000000000001011111",	-- instrucción 410
	"000000000000000000000000001011111",	-- instrucción 411
	"000000000000000000000000001011111",	-- instrucción 412
	"000000000000000000000000001011111",	-- instrucción 413
	"000000000000000000000000001011111",	-- instrucción 414
	"000000000000000000000000001011111",	-- instrucción 415
	"000000000000000000000000001011111",	-- instrucción 416
	"000000000000000000000000001011111",	-- instrucción 417
	"000000000000000000000000001011111",	-- instrucción 418
	"000000000000000000000000001011111",	-- instrucción 419
	"000000000000000000000000001011111",	-- instrucción 420
	"000000000000000000000000001011111",	-- instrucción 421
	"000000000000000000000000001011111",	-- instrucción 422
	"000000000000000000000000001011111",	-- instrucción 423
	"000000000000000000000000001011111",	-- instrucción 424
	"000000000000000000000000001011111",	-- instrucción 425
	"000000000000000000000000001011111",	-- instrucción 426
	"000000000000000000000000001011111",	-- instrucción 427
	"000000000000000000000000001011111",	-- instrucción 428
	"000000000000000000000000001011111",	-- instrucción 429
	"000000000000000000000000001011111",	-- instrucción 430
	"000000000000000000000000001011111",	-- instrucción 431
	"000000000000000000000000001011111",	-- instrucción 432
	"000000000000000000000000001011111",	-- instrucción 433
	"000000000000000000000000001011111",	-- instrucción 434
	"000000000000000000000000001011111",	-- instrucción 435
	"000000000000000000000000001011111",	-- instrucción 436
	"000000000000000000000000001011111",	-- instrucción 437
	"000000000000000000000000001011111",	-- instrucción 438
	"000000000000000000000000001011111",	-- instrucción 439
	"000000000000000000000000001011111",	-- instrucción 440
	"000000000000000000000000001011111",	-- instrucción 441
	"000000000000000000000000001011111",	-- instrucción 442
