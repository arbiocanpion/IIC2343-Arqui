...
with Opcode select OutSignal <=
	...
	"00101100000000000"									when "0000011", -- MOV B, Lit
	...
	"00101110000100000"									when "0001001", -- MOV B, DirB
	...
	"00100110110000000"									when "0100101", -- OR B, Dir
	...
	"01000011110000000"									when "0110001", -- SHL A
	"00100011110000000"									when "0110010", -- SHL B, A
	"00000011110000100"									when "0110011", -- SHL Dir, A
	"01000011100000000"									when "0110100", -- SHR A
	"00100011100000000"									when "0110101", -- SHR B, A
	"00000011100000100"									when "0110110", -- SHR Dir, A
	"01000100000000000"									when "0110111", -- INC A
	"00110000000000000"									when "0111000", -- INC B
	"00010110000000100"									when "0111001", -- INC Dir
	"01000100010000000"									when "0111010", -- DEC A
	"00000000010000000"									when "0111011", -- CMP A, B
	"00000100010000000"									when "0111100", -- CMP A, Lit
	"00000110010000000"									when "0111101", -- CMP A, Dir
	"10000000000000000"									when "0111110", -- JMP Dir
	(Z)	&							"0000000000000000"	when "0111111", -- JEQ Dir
	(not Z) &						"0000000000000000"	when "1000000", -- JNE Dir
	((not N) and (not Z)) &			"0000000000000000"	when "1000001", -- JGT Dir
	(not N) &						"0000000000000000"	when "1000010", -- JGE Dir
	N &								"0000000000000000"	when "1000011", -- JLT Dir
	(N xor Z) &						"0000000000000000"	when "1000100", -- JLE Dir
	C &								"0000000000000000"	when "1000101", -- JCR Dir
