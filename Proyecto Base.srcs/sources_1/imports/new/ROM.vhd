...
signal memory : memory_array:= (
	"000000000000000000000000000000010",	-- instrucción 1 - Assembler.MovInstruction A, Lit
	"000000000000000000000000000000110",	-- instrucción 2 - Assembler.MovInstruction Dir, A
	"000000000000000000000000000000010",	-- instrucción 3 - Assembler.MovInstruction A, Lit
	"000000000000000100000000000000110",	-- instrucción 4 - Assembler.MovInstruction Dir, A
	"000000000000000000000000000000010",	-- instrucción 5 - Assembler.MovInstruction A, Lit
	"000000000000001000000000000000110",	-- instrucción 6 - Assembler.MovInstruction Dir, A
	"000000000000010000000000000000010",	-- instrucción 7 - Assembler.MovInstruction A, Lit
	"000000000000001100000000000000110",	-- instrucción 8 - Assembler.MovInstruction Dir, A
	"000000000000001000000000000000010",	-- instrucción 9 - Assembler.MovInstruction A, Lit
	"000000000000010000000000000000110",	-- instrucción 10 - Assembler.MovInstruction Dir, A
	"000000000000001000000000000000010",	-- instrucción 11 - Assembler.MovInstruction A, Lit
	"000000000000010100000000000000110",	-- instrucción 12 - Assembler.MovInstruction Dir, A
	"000000000000000100000000000000010",	-- instrucción 13 - Assembler.MovInstruction A, Lit
	"000000000000011000000000000000110",	-- instrucción 14 - Assembler.MovInstruction Dir, A
	"000000000000001100000000000000010",	-- instrucción 15 - Assembler.MovInstruction A, Lit
	"000000000000011100000000000000110",	-- instrucción 16 - Assembler.MovInstruction Dir, A
	"000000000000010100000000000000010",	-- instrucción 17 - Assembler.MovInstruction A, Lit
	"000000000000100000000000000000110",	-- instrucción 18 - Assembler.MovInstruction Dir, A
	"000000000110010000000000000000010",	-- instrucción 19 - Assembler.MovInstruction A, Lit
	"000000000000100100000000000000110",	-- instrucción 20 - Assembler.MovInstruction Dir, A
	"000000000001011100000000000000010",	-- instrucción 21 - Assembler.MovInstruction A, Lit
	"000000000000101000000000000000110",	-- instrucción 22 - Assembler.MovInstruction Dir, A
	"000000000101000000000000000000010",	-- instrucción 23 - Assembler.MovInstruction A, Lit
	"000000000000101100000000000000110",	-- instrucción 24 - Assembler.MovInstruction Dir, A
	"000000000000001100000000000000010",	-- instrucción 25 - Assembler.MovInstruction A, Lit
	"000000000000110000000000000000110",	-- instrucción 26 - Assembler.MovInstruction Dir, A
	"000000000000100100000000000000010",	-- instrucción 27 - Assembler.MovInstruction A, Lit
	"000000000000110100000000000000110",	-- instrucción 28 - Assembler.MovInstruction Dir, A
	"000000000001110000000000000000010",	-- instrucción 29 - Assembler.MovInstruction A, Lit
	"000000000000111000000000000000110",	-- instrucción 30 - Assembler.MovInstruction Dir, A
	"000000000000100100000000000000010",	-- instrucción 31 - Assembler.MovInstruction A, Lit
	"000000000000111100000000000000110",	-- instrucción 32 - Assembler.MovInstruction Dir, A
	"000000000000000100000000000000010",	-- instrucción 33 - Assembler.MovInstruction A, Lit
	"000000000001000000000000000000110",	-- instrucción 34 - Assembler.MovInstruction Dir, A
	"000000000000100000000000000000010",	-- instrucción 35 - Assembler.MovInstruction A, Lit
	"000000000001000100000000000000110",	-- instrucción 36 - Assembler.MovInstruction Dir, A
	"000000000011011000000000000000010",	-- instrucción 37 - Assembler.MovInstruction A, Lit
	"000000000001001000000000000000110",	-- instrucción 38 - Assembler.MovInstruction Dir, A
	"000000000011101000000000000000010",	-- instrucción 39 - Assembler.MovInstruction A, Lit
	"000000000001001100000000000000110",	-- instrucción 40 - Assembler.MovInstruction Dir, A
	"000000000011000100000000000000010",	-- instrucción 41 - Assembler.MovInstruction A, Lit
	"000000000001010000000000000000110",	-- instrucción 42 - Assembler.MovInstruction Dir, A
	"000000000000111100000000000000010",	-- instrucción 43 - Assembler.MovInstruction A, Lit
	"000000000001010100000000000000110",	-- instrucción 44 - Assembler.MovInstruction Dir, A
	"000000000001111100000000000000010",	-- instrucción 45 - Assembler.MovInstruction A, Lit
	"000000000001011000000000000000110",	-- instrucción 46 - Assembler.MovInstruction Dir, A
	"000000000100110000000000000000010",	-- instrucción 47 - Assembler.MovInstruction A, Lit
	"000000000001011100000000000000110",	-- instrucción 48 - Assembler.MovInstruction Dir, A
	"000000000010110000000000000000010",	-- instrucción 49 - Assembler.MovInstruction A, Lit
	"000000000001100000000000000000110",	-- instrucción 50 - Assembler.MovInstruction Dir, A
	"000000000010011000000000000000010",	-- instrucción 51 - Assembler.MovInstruction A, Lit
	"000000000001100100000000000000110",	-- instrucción 52 - Assembler.MovInstruction Dir, A
	"000000000100110100000000000000010",	-- instrucción 53 - Assembler.MovInstruction A, Lit
	"000000000001101000000000000000110",	-- instrucción 54 - Assembler.MovInstruction Dir, A
	"000000000101101000000000000000010",	-- instrucción 55 - Assembler.MovInstruction A, Lit
	"000000000001101100000000000000110",	-- instrucción 56 - Assembler.MovInstruction Dir, A
	"000000000000010000000000000000010",	-- instrucción 57 - Assembler.MovInstruction A, Lit
	"000000000001110000000000000000110",	-- instrucción 58 - Assembler.MovInstruction Dir, A
	"000000000010111100000000000000010",	-- instrucción 59 - Assembler.MovInstruction A, Lit
	"000000000001110100000000000000110",	-- instrucción 60 - Assembler.MovInstruction Dir, A
	"000000000000010000000000000000010",	-- instrucción 61 - Assembler.MovInstruction A, Lit
	"000000000001111000000000000000110",	-- instrucción 62 - Assembler.MovInstruction Dir, A
	"000000000101000100000000000000010",	-- instrucción 63 - Assembler.MovInstruction A, Lit
	"000000000001111100000000000000110",	-- instrucción 64 - Assembler.MovInstruction Dir, A
	"000000000011101100000000000000010",	-- instrucción 65 - Assembler.MovInstruction A, Lit
	"000000000010000000000000000000110",	-- instrucción 66 - Assembler.MovInstruction Dir, A
	"000000000001101000000000000000010",	-- instrucción 67 - Assembler.MovInstruction A, Lit
	"000000000010000100000000000000110",	-- instrucción 68 - Assembler.MovInstruction Dir, A
	"000000000000010100000000000000010",	-- instrucción 69 - Assembler.MovInstruction A, Lit
	"000000000010001000000000000000110",	-- instrucción 70 - Assembler.MovInstruction Dir, A
	"000000000101001000000000000000010",	-- instrucción 71 - Assembler.MovInstruction A, Lit
	"000000000010001100000000000000110",	-- instrucción 72 - Assembler.MovInstruction Dir, A
	"000000000010010100000000000000010",	-- instrucción 73 - Assembler.MovInstruction A, Lit
	"000000000010010000000000000000110",	-- instrucción 74 - Assembler.MovInstruction Dir, A
	"000000000010000000000000000000010",	-- instrucción 75 - Assembler.MovInstruction A, Lit
	"000000000010010100000000000000110",	-- instrucción 76 - Assembler.MovInstruction Dir, A
	"000000000100000100000000000000010",	-- instrucción 77 - Assembler.MovInstruction A, Lit
	"000000000010011000000000000000110",	-- instrucción 78 - Assembler.MovInstruction Dir, A
	"000000000101010100000000000000010",	-- instrucción 79 - Assembler.MovInstruction A, Lit
	"000000000010011100000000000000110",	-- instrucción 80 - Assembler.MovInstruction Dir, A
	"000000000000100100000000000000010",	-- instrucción 81 - Assembler.MovInstruction A, Lit
	"000000000010100000000000000000110",	-- instrucción 82 - Assembler.MovInstruction Dir, A
	"000000000101111100000000000000010",	-- instrucción 83 - Assembler.MovInstruction A, Lit
	"000000000010100100000000000000110",	-- instrucción 84 - Assembler.MovInstruction Dir, A
	"000000000000110100000000000000010",	-- instrucción 85 - Assembler.MovInstruction A, Lit
	"000000000010101000000000000000110",	-- instrucción 86 - Assembler.MovInstruction Dir, A
	"000000000101011100000000000000010",	-- instrucción 87 - Assembler.MovInstruction A, Lit
	"000000000010101100000000000000110",	-- instrucción 88 - Assembler.MovInstruction Dir, A
	"000000000010000100000000000000010",	-- instrucción 89 - Assembler.MovInstruction A, Lit
	"000000000010110000000000000000110",	-- instrucción 90 - Assembler.MovInstruction Dir, A
	"000000000000101100000000000000010",	-- instrucción 91 - Assembler.MovInstruction A, Lit
	"000000000010110100000000000000110",	-- instrucción 92 - Assembler.MovInstruction Dir, A
	"000000000001011000000000000000010",	-- instrucción 93 - Assembler.MovInstruction A, Lit
	"000000000010111000000000000000110",	-- instrucción 94 - Assembler.MovInstruction Dir, A
	"000000000100001100000000000000010",	-- instrucción 95 - Assembler.MovInstruction A, Lit
	"000000000010111100000000000000110",	-- instrucción 96 - Assembler.MovInstruction Dir, A
	"000000000011110100000000000000010",	-- instrucción 97 - Assembler.MovInstruction A, Lit
	"000000000011000000000000000000110",	-- instrucción 98 - Assembler.MovInstruction Dir, A
	"000000000101001100000000000000010",	-- instrucción 99 - Assembler.MovInstruction A, Lit
	"000000000011000100000000000000110",	-- instrucción 100 - Assembler.MovInstruction Dir, A
	"000000000010010100000000000000010",	-- instrucción 101 - Assembler.MovInstruction A, Lit
	"000000000011001000000000000000110",	-- instrucción 102 - Assembler.MovInstruction Dir, A
	"000000000010000100000000000000010",	-- instrucción 103 - Assembler.MovInstruction A, Lit
	"000000000011001100000000000000110",	-- instrucción 104 - Assembler.MovInstruction Dir, A
	"000000000000000000000000000000010",	-- instrucción 105 - Assembler.MovInstruction A, Lit
	"000000000011010000000000000000110",	-- instrucción 106 - Assembler.MovInstruction Dir, A
	"000000000000000000000000000000010",	-- instrucción 107 - Assembler.MovInstruction A, Lit
	"000000000011010100000000000000110",	-- instrucción 108 - Assembler.MovInstruction Dir, A
	"000000000000000000000000000000010",	-- instrucción 109 - Assembler.MovInstruction A, Lit
	"000000000011011000000000000000110",	-- instrucción 110 - Assembler.MovInstruction Dir, A
	"000000000000000000000000000000010",	-- instrucción 111 - Assembler.MovInstruction A, Lit
	"000000000011011100000000000000110",	-- instrucción 112 - Assembler.MovInstruction Dir, A
	"000000000000000000000000000000010",	-- instrucción 113 - Assembler.MovInstruction A, Lit
	"000000000011100000000000000000110",	-- instrucción 114 - Assembler.MovInstruction Dir, A
	"000000000000000000000000000000010",	-- instrucción 115 - Assembler.MovInstruction A, Lit
	"000000000011100100000000000000110",	-- instrucción 116 - Assembler.MovInstruction Dir, A
	"000000000000000000000000000000010",	-- instrucción 117 - Assembler.MovInstruction A, Lit
	"000000000011101000000000000000110",	-- instrucción 118 - Assembler.MovInstruction Dir, A
	"000000000000100000000000000000100",	-- instrucción 119 - Assembler.MovInstruction A, Dir
	"000000000000001100000000000000011",	-- instrucción 120 - Assembler.MovInstruction B, Lit
	"000000001010000000000000001010010",	-- instrucción 121 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000001000000000000000010",	-- instrucción 122 - Assembler.MovInstruction A, Lit
	"000000000000000000000000001001100",	-- instrucción 123 - Assembler.CmpInstruction A, Dir
	"000000001001110100000000001011001",	-- instrucción 124 - Assembler.Instructions.JneInstruction Lit, None
	"000000000000001000000000000000010",	-- instrucción 125 - Assembler.MovInstruction A, Lit
	"000000000000000100000000001001100",	-- instrucción 126 - Assembler.CmpInstruction A, Dir
	"000000001001110100000000001011001",	-- instrucción 127 - Assembler.Instructions.JneInstruction Lit, None
	"000000000000001000000000000000010",	-- instrucción 128 - Assembler.MovInstruction A, Lit
	"000000000000001000000000001001100",	-- instrucción 129 - Assembler.CmpInstruction A, Dir
	"000000001001110100000000001011001",	-- instrucción 130 - Assembler.Instructions.JneInstruction Lit, None
	"000000000001000100000000000000100",	-- instrucción 131 - Assembler.MovInstruction A, Dir
	"000000000000100100000000000000011",	-- instrucción 132 - Assembler.MovInstruction B, Lit
	"000000001010000000000000001010010",	-- instrucción 133 - Assembler.Instructions.CallInstruction Lit, None
	"000000000010000000000000000000010",	-- instrucción 134 - Assembler.MovInstruction A, Lit
	"000000000000000000000000001001100",	-- instrucción 135 - Assembler.CmpInstruction A, Dir
	"000000001001110100000000001011001",	-- instrucción 136 - Assembler.Instructions.JneInstruction Lit, None
	"000000000001000000000000000000010",	-- instrucción 137 - Assembler.MovInstruction A, Lit
	"000000000000000100000000001001100",	-- instrucción 138 - Assembler.CmpInstruction A, Dir
	"000000001001110100000000001011001",	-- instrucción 139 - Assembler.Instructions.JneInstruction Lit, None
	"000000000000100100000000000000010",	-- instrucción 140 - Assembler.MovInstruction A, Lit
	"000000000000001000000000001001100",	-- instrucción 141 - Assembler.CmpInstruction A, Dir
	"000000001001110100000000001011001",	-- instrucción 142 - Assembler.Instructions.JneInstruction Lit, None
	"000000000011001100000000000000100",	-- instrucción 143 - Assembler.MovInstruction A, Dir
	"000000000001001000000000000000011",	-- instrucción 144 - Assembler.MovInstruction B, Lit
	"000000001010000000000000001010010",	-- instrucción 145 - Assembler.Instructions.CallInstruction Lit, None
	"000000000011000000000000000000010",	-- instrucción 146 - Assembler.MovInstruction A, Lit
	"000000000000000000000000001001100",	-- instrucción 147 - Assembler.CmpInstruction A, Dir
	"000000001001110100000000001011001",	-- instrucción 148 - Assembler.Instructions.JneInstruction Lit, None
	"000000000010111100000000000000010",	-- instrucción 149 - Assembler.MovInstruction A, Lit
	"000000000000000100000000001001100",	-- instrucción 150 - Assembler.CmpInstruction A, Dir
	"000000001001110100000000001011001",	-- instrucción 151 - Assembler.Instructions.JneInstruction Lit, None
	"000000000000010000000000000000010",	-- instrucción 152 - Assembler.MovInstruction A, Lit
	"000000000000001000000000001001100",	-- instrucción 153 - Assembler.CmpInstruction A, Dir
	"000000001001110100000000001011001",	-- instrucción 154 - Assembler.Instructions.JneInstruction Lit, None
	"000000001010101000000000000000010",	-- instrucción 155 - Assembler.MovInstruction A, Lit
	"000000001010101000000000000000011",	-- instrucción 156 - Assembler.MovInstruction B, Lit
	"000000001001101000000000001010111",	-- instrucción 157 - Assembler.Instructions.JmpInstruction Lit, None
	"000000001111111100000000000000010",	-- instrucción 158 - Assembler.MovInstruction A, Lit
	"000000001111111100000000000000011",	-- instrucción 159 - Assembler.MovInstruction B, Lit
	"000000001001110100000000001010111",	-- instrucción 160 - Assembler.Instructions.JmpInstruction Lit, None
	"000000010000010000000000001010010",	-- instrucción 161 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000001001110",	-- instrucción 162 - Assembler.Instructions.PushInstruction A, None
	"000000010111000000000000001010010",	-- instrucción 163 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000000000110",	-- instrucción 164 - Assembler.MovInstruction Dir, A
	"000000000000000100000000001100000",	-- instrucción 165 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 166 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000000000000001001110",	-- instrucción 167 - Assembler.Instructions.PushInstruction A, None
	"000000010111101000000000001010010",	-- instrucción 168 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000000000110",	-- instrucción 169 - Assembler.MovInstruction Dir, A
	"000000000000000100000000001100000",	-- instrucción 170 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 171 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000000000000001001110",	-- instrucción 172 - Assembler.Instructions.PushInstruction A, None
	"000000011001010100000000001010010",	-- instrucción 173 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000001000000000000000110",	-- instrucción 174 - Assembler.MovInstruction Dir, A
	"000000000000000100000000001100000",	-- instrucción 175 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 176 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 177 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 178 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000000110000",	-- instrucción 179 - Assembler.XorInstruction A, B
	"000000000000000000000000000110001",	-- instrucción 180 - Assembler.XorInstruction B, A
	"000000000000000000000000000110000",	-- instrucción 181 - Assembler.XorInstruction A, B
	"000000000000000100000000001100001",	-- instrucción 182 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 183 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001111",	-- instrucción 184 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000001001110",	-- instrucción 185 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 186 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000000001001",	-- instrucción 187 - Assembler.MovInstruction B, DirB
	"000000000011010000000000000000111",	-- instrucción 188 - Assembler.MovInstruction Dir, B
	"000000001011001000000000001010010",	-- instrucción 189 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000000001000",	-- instrucción 190 - Assembler.MovInstruction A, DirB
	"000000000000000100000000001100000",	-- instrucción 191 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 192 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000000000000000001010",	-- instrucción 193 - Assembler.MovInstruction DirB, A
	"000000000011010000000000000000100",	-- instrucción 194 - Assembler.MovInstruction A, Dir
	"000000000000000100000000001100000",	-- instrucción 195 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 196 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000000000000000001010",	-- instrucción 197 - Assembler.MovInstruction DirB, A
	...
	"000000001011001000000000001010010",	-- instrucción 200 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 201 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 202 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000000001001",	-- instrucción 203 - Assembler.MovInstruction B, DirB
	"000000001011001000000000001010010",	-- instrucción 204 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000000001001",	-- instrucción 205 - Assembler.MovInstruction B, DirB
	"000000001011001000000000001010010",	-- instrucción 206 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100001",	-- instrucción 207 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 208 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001111",	-- instrucción 209 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000000000011",	-- instrucción 210 - Assembler.MovInstruction B, Lit
	"000000000011011000000000000000111",	-- instrucción 211 - Assembler.MovInstruction Dir, B
	"000000000000000100000000001100000",	-- instrucción 212 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 213 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000000000000001001010",	-- instrucción 214 - Assembler.CmpInstruction A, B
	"000000001101101000000000001011100",	-- instrucción 215 - Assembler.Instructions.JltInstruction Lit, None
	"000000000000000000000000000010101",	-- instrucción 216 - Assembler.SubInstruction A, B
	"000000000011011000000000001000111",	-- instrucción 217 - Assembler.IncInstruction Dir, Lit
	"000000001101010100000000001010111",	-- instrucción 218 - Assembler.Instructions.JmpInstruction Lit, None
	"000000001011001000000000001010010",	-- instrucción 219 - Assembler.Instructions.CallInstruction Lit, None
	"000000000011011000000000000000100",	-- instrucción 220 - Assembler.MovInstruction A, Dir
	...
	"000000000000000000000000001001111",	-- instrucción 223 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000000111101",	-- instrucción 224 - Assembler.ShlInstruction A, None
	"000000001101000000000000001010010",	-- instrucción 225 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001000101",	-- instrucción 226 - Assembler.IncInstruction A, Lit
	"000000000000000000000000001000001",	-- instrucción 227 - Assembler.ShrInstruction A, None
	"000000000000000100000000001100000",	-- instrucción 228 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 229 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100001",	-- instrucción 230 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 231 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001111",	-- instrucción 232 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000001001111",	-- instrucción 233 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000000000011",	-- instrucción 234 - Assembler.MovInstruction B, Lit
	"000000000011011000000000000000111",	-- instrucción 235 - Assembler.MovInstruction Dir, B
	"000000000000000100000000001100000",	-- instrucción 236 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 237 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000000000000001001111",	-- instrucción 238 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000001001110",	-- instrucción 239 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001011",	-- instrucción 240 - Assembler.CmpInstruction A, Lit
	"000000001111101100000000001011000",	-- instrucción 241 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000011011000000000000000100",	-- instrucción 242 - Assembler.MovInstruction A, Dir
	"000000000000000000000000000010011",	-- instrucción 243 - Assembler.AddInstruction A, DirB
	"000000000011011000000000000000110",	-- instrucción 244 - Assembler.MovInstruction Dir, A
	"000000000000000100000000001100000",	-- instrucción 245 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 246 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100000",	-- instrucción 247 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 248 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001001001",	-- instrucción 249 - Assembler.Instructions.DecInstruction A, Lit
	"000000000000000000000000001000110",	-- instrucción 250 - Assembler.IncInstruction B, Lit
	"000000001110110100000000001010111",	-- instrucción 251 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 252 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 253 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100000",	-- instrucción 254 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 255 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100000",	-- instrucción 256 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 257 - Assembler.Instructions.Pop2Instruction B, None
	"000000000011011000000000000000100",	-- instrucción 258 - Assembler.MovInstruction A, Dir
	...
	"000000000000000000000000001001111",	-- instrucción 261 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000001001110",	-- instrucción 262 - Assembler.Instructions.PushInstruction A, None
	"000000010010011000000000001010010",	-- instrucción 263 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000001100000000001001011",	-- instrucción 264 - Assembler.CmpInstruction A, Lit
	"000000010000110000000000001011100",	-- instrucción 265 - Assembler.Instructions.JltInstruction Lit, None
	"000000000000001000000000000010111",	-- instrucción 266 - Assembler.SubInstruction A, Lit
	"000000000000000000000000001000110",	-- instrucción 267 - Assembler.IncInstruction B, Lit
	"000000010000011000000000001010111",	-- instrucción 268 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 269 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 270 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100000",	-- instrucción 271 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 272 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100001",	-- instrucción 273 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 274 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 275 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 276 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000000001100",	-- instrucción 277 - Assembler.AddInstruction A, B
	"000000001100101000000000001010010",	-- instrucción 278 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000001001010",	-- instrucción 279 - Assembler.CmpInstruction A, B
	"000000010010000000000000001011011",	-- instrucción 280 - Assembler.Instructions.JgeInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 281 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 282 - Assembler.Instructions.Pop2Instruction B, None
	...
	"000000000000000000000000001001110",	-- instrucción 285 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000001100",	-- instrucción 286 - Assembler.AddInstruction A, B
	"000000001011011100000000001010010",	-- instrucción 287 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000001001111",	-- instrucción 288 - Assembler.Instructions.PushInstruction B, None
	"000000000000000100000000001100000",	-- instrucción 289 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 290 - Assembler.Instructions.Pop2Instruction B, None
	...
	"000000000000000100000000001100001",	-- instrucción 293 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 294 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001111",	-- instrucción 295 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000001001110",	-- instrucción 296 - Assembler.Instructions.PushInstruction A, None
	"000000000000000100000000001001011",	-- instrucción 297 - Assembler.CmpInstruction A, Lit
	"000000010011100000000000001011101",	-- instrucción 298 - Assembler.Instructions.JleInstruction Lit, None
	"000000000000000100000000001001001",	-- instrucción 299 - Assembler.Instructions.DecInstruction A, Lit
	"000000010001001000000000001010010",	-- instrucción 300 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001001011",	-- instrucción 301 - Assembler.CmpInstruction A, Lit
	"000000010011100000000000001011101",	-- instrucción 302 - Assembler.Instructions.JleInstruction Lit, None
	"000000000000000000000000001001110",	-- instrucción 303 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000000010",	-- instrucción 304 - Assembler.MovInstruction A, Lit
	"000000000011010100000000000000110",	-- instrucción 305 - Assembler.MovInstruction Dir, A
	"000000000000000100000000001100000",	-- instrucción 306 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 307 - Assembler.Instructions.Pop2Instruction A, None
	"000000000011010100000000001000111",	-- instrucción 308 - Assembler.IncInstruction Dir, Lit
	"000000010011111000000000001010010",	-- instrucción 309 - Assembler.Instructions.CallInstruction Lit, None
	"000000010101010000000000001010010",	-- instrucción 310 - Assembler.Instructions.CallInstruction Lit, None
	"000000000011010100000000001001100",	-- instrucción 311 - Assembler.CmpInstruction A, Dir
	"000000010011001100000000001011010",	-- instrucción 312 - Assembler.Instructions.JgtInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 313 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 314 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100000",	-- instrucción 315 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 316 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100001",	-- instrucción 317 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 318 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 319 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 320 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000000000000",	-- instrucción 321 - Assembler.MovInstruction A, B
	"000000000011010100000000000010000",	-- instrucción 322 - Assembler.AddInstruction A, Dir
	"000000001100101000000000001010010",	-- instrucción 323 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000001001010",	-- instrucción 324 - Assembler.CmpInstruction A, B
	"000000010100111000000000001011011",	-- instrucción 325 - Assembler.Instructions.JgeInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 326 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 327 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100000",	-- instrucción 328 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 329 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000000000000001001110",	-- instrucción 330 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 331 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000000000000",	-- instrucción 332 - Assembler.MovInstruction A, B
	"000000000011010100000000000010000",	-- instrucción 333 - Assembler.AddInstruction A, Dir
	"000000001011011100000000001010010",	-- instrucción 334 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 335 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 336 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100000",	-- instrucción 337 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 338 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 339 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 340 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001110",	-- instrucción 341 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 342 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000001001111",	-- instrucción 343 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000000001101",	-- instrucción 344 - Assembler.AddInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 345 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 346 - Assembler.Instructions.Pop2Instruction A, None
	"000000000011010100000000000010000",	-- instrucción 347 - Assembler.AddInstruction A, Dir
	"000000001100101000000000001010010",	-- instrucción 348 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000000000000001001010",	-- instrucción 349 - Assembler.CmpInstruction A, B
	"000000010100111000000000001011101",	-- instrucción 350 - Assembler.Instructions.JleInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 351 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 352 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100000",	-- instrucción 353 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 354 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000000000000001001110",	-- instrucción 355 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001001111",	-- instrucción 356 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000001001111",	-- instrucción 357 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000000001101",	-- instrucción 358 - Assembler.AddInstruction B, A
	"000000000000000100000000001100000",	-- instrucción 359 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 360 - Assembler.Instructions.Pop2Instruction A, None
	"000000000011010100000000000010000",	-- instrucción 361 - Assembler.AddInstruction A, Dir
	"000000001011011100000000001010010",	-- instrucción 362 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 363 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 364 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100000",	-- instrucción 365 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 366 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001100001",	-- instrucción 367 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 368 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001111",	-- instrucción 369 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000001001110",	-- instrucción 370 - Assembler.Instructions.PushInstruction A, None
	"000000001110011100000000001010010",	-- instrucción 371 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 372 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 373 - Assembler.Instructions.Pop2Instruction B, None
	"000000001101111000000000001010010",	-- instrucción 374 - Assembler.Instructions.CallInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 375 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 376 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100001",	-- instrucción 377 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 378 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001111",	-- instrucción 379 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000001001110",	-- instrucción 380 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000001000001",	-- instrucción 381 - Assembler.ShrInstruction A, None
	"000000011000110000000000001011110",	-- instrucción 382 - Assembler.Instructions.JcrInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 383 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 384 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000100000000001001001",	-- instrucción 385 - Assembler.Instructions.DecInstruction A, Lit
	"000000000000000000000000001000001",	-- instrucción 386 - Assembler.ShrInstruction A, None
	"000000000000000000000000000001101",	-- instrucción 387 - Assembler.AddInstruction B, A
	"000000000000000000000000000001000",	-- instrucción 388 - Assembler.MovInstruction A, DirB
	"000000000000000000000000001000110",	-- instrucción 389 - Assembler.IncInstruction B, Lit
	"000000000000000000000000000010011",	-- instrucción 390 - Assembler.AddInstruction A, DirB
	"000000000000000100000000001000101",	-- instrucción 391 - Assembler.IncInstruction A, Lit
	"000000000000000000000000001000001",	-- instrucción 392 - Assembler.ShrInstruction A, None
	"000000000000000100000000001100000",	-- instrucción 393 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 394 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100001",	-- instrucción 395 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 396 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000100000000001100000",	-- instrucción 397 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 398 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000000000000001000001",	-- instrucción 399 - Assembler.ShrInstruction A, None
	"000000000000000000000000000001101",	-- instrucción 400 - Assembler.AddInstruction B, A
	"000000000000000000000000000001000",	-- instrucción 401 - Assembler.MovInstruction A, DirB
	"000000000000000100000000001100000",	-- instrucción 402 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 403 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000100000000001100001",	-- instrucción 404 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 405 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001001111",	-- instrucción 406 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000001001111",	-- instrucción 407 - Assembler.Instructions.PushInstruction B, None
	"000000000000000000000000000000011",	-- instrucción 408 - Assembler.MovInstruction B, Lit
	"000000000011100100000000000000111",	-- instrucción 409 - Assembler.MovInstruction Dir, B
	"000000000011101000000000000000111",	-- instrucción 410 - Assembler.MovInstruction Dir, B
	"000000000000000100000000001100000",	-- instrucción 411 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 412 - Assembler.Instructions.Pop2Instruction B, None
	"000000000000000000000000001001110",	-- instrucción 413 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000001000",	-- instrucción 414 - Assembler.MovInstruction A, DirB
	"000000000011011100000000000000110",	-- instrucción 415 - Assembler.MovInstruction Dir, A
	"000000000011100000000000000000110",	-- instrucción 416 - Assembler.MovInstruction Dir, A
	"000000000000000100000000001100000",	-- instrucción 417 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010000",	-- instrucción 418 - Assembler.Instructions.Pop2Instruction A, None
	"000000000000000000000000001001011",	-- instrucción 419 - Assembler.CmpInstruction A, Lit
	"000000011011010100000000001011000",	-- instrucción 420 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000000000100000000001001001",	-- instrucción 421 - Assembler.Instructions.DecInstruction A, Lit
	"000000000000000000000000001001110",	-- instrucción 422 - Assembler.Instructions.PushInstruction A, None
	"000000000000000000000000000001000",	-- instrucción 423 - Assembler.MovInstruction A, DirB
	"000000000011011100000000001001100",	-- instrucción 424 - Assembler.CmpInstruction A, Dir
	"000000011010110000000000001011000",	-- instrucción 425 - Assembler.Instructions.JeqInstruction Lit, None
	"000000000011011100000000000000110",	-- instrucción 426 - Assembler.MovInstruction Dir, A
	"000000000000000000000000000000010",	-- instrucción 427 - Assembler.MovInstruction A, Lit
	"000000000011101000000000000000110",	-- instrucción 428 - Assembler.MovInstruction Dir, A
	"000000000011101000000000001000111",	-- instrucción 429 - Assembler.IncInstruction Dir, Lit
	"000000000000000000000000001000110",	-- instrucción 430 - Assembler.IncInstruction B, Lit
	"000000000011101000000000000000100",	-- instrucción 431 - Assembler.MovInstruction A, Dir
	"000000000011100100000000001001100",	-- instrucción 432 - Assembler.CmpInstruction A, Dir
	"000000011010000000000000001011101",	-- instrucción 433 - Assembler.Instructions.JleInstruction Lit, None
	"000000000011100100000000000000110",	-- instrucción 434 - Assembler.MovInstruction Dir, A
	"000000000011011100000000000000100",	-- instrucción 435 - Assembler.MovInstruction A, Dir
	"000000000011100000000000000000110",	-- instrucción 436 - Assembler.MovInstruction Dir, A
	"000000011010000000000000001010111",	-- instrucción 437 - Assembler.Instructions.JmpInstruction Lit, None
	"000000000000000100000000001100000",	-- instrucción 438 - Assembler.Instructions.Pop1Instruction Lit, None
	"000000000000000000000000001010001",	-- instrucción 439 - Assembler.Instructions.Pop2Instruction B, None
	"000000000011100000000000000000100",	-- instrucción 440 - Assembler.MovInstruction A, Dir
	"000000000000000100000000001100001",	-- instrucción 441 - Assembler.Instructions.Ret1Instruction Lit, None
	"000000000000000000000000001010011",	-- instrucción 442 - Assembler.Instructions.Ret2Instruction None, None
	"000000000000000000000000001011111",	-- instrucción 443
	"000000000000000000000000001011111",	-- instrucción 444
	"000000000000000000000000001011111",	-- instrucción 445
	"000000000000000000000000001011111",	-- instrucción 446
	"000000000000000000000000001011111",	-- instrucción 447
	"000000000000000000000000001011111",	-- instrucción 448
	"000000000000000000000000001011111",	-- instrucción 449
	"000000000000000000000000001011111",	-- instrucción 450
	"000000000000000000000000001011111",	-- instrucción 451
	"000000000000000000000000001011111",	-- instrucción 452
	"000000000000000000000000001011111",	-- instrucción 453
	"000000000000000000000000001011111",	-- instrucción 454
	"000000000000000000000000001011111",	-- instrucción 455
	"000000000000000000000000001011111",	-- instrucción 456
	"000000000000000000000000001011111",	-- instrucción 457
	"000000000000000000000000001011111",	-- instrucción 458
	"000000000000000000000000001011111",	-- instrucción 459
	"000000000000000000000000001011111",	-- instrucción 460
	"000000000000000000000000001011111",	-- instrucción 461
	"000000000000000000000000001011111",	-- instrucción 462
	"000000000000000000000000001011111",	-- instrucción 463
	"000000000000000000000000001011111",	-- instrucción 464
	"000000000000000000000000001011111",	-- instrucción 465
	"000000000000000000000000001011111",	-- instrucción 466
	"000000000000000000000000001011111",	-- instrucción 467
	"000000000000000000000000001011111",	-- instrucción 468
	"000000000000000000000000001011111",	-- instrucción 469
	"000000000000000000000000001011111",	-- instrucción 470
	"000000000000000000000000001011111",	-- instrucción 471
	"000000000000000000000000001011111",	-- instrucción 472
	"000000000000000000000000001011111",	-- instrucción 473
	"000000000000000000000000001011111",	-- instrucción 474
	"000000000000000000000000001011111",	-- instrucción 475
	"000000000000000000000000001011111",	-- instrucción 476
	"000000000000000000000000001011111",	-- instrucción 477
	"000000000000000000000000001011111",	-- instrucción 478
	"000000000000000000000000001011111",	-- instrucción 479
	"000000000000000000000000001011111",	-- instrucción 480
	"000000000000000000000000001011111",	-- instrucción 481
	"000000000000000000000000001011111",	-- instrucción 482
	"000000000000000000000000001011111",	-- instrucción 483
	"000000000000000000000000001011111",	-- instrucción 484
	"000000000000000000000000001011111",	-- instrucción 485
	"000000000000000000000000001011111",	-- instrucción 486
	"000000000000000000000000001011111",	-- instrucción 487
	"000000000000000000000000001011111",	-- instrucción 488
	"000000000000000000000000001011111",	-- instrucción 489
	"000000000000000000000000001011111",	-- instrucción 490
	"000000000000000000000000001011111",	-- instrucción 491
	"000000000000000000000000001011111",	-- instrucción 492
	"000000000000000000000000001011111",	-- instrucción 493
	"000000000000000000000000001011111",	-- instrucción 494
	"000000000000000000000000001011111",	-- instrucción 495
	"000000000000000000000000001011111",	-- instrucción 496
	"000000000000000000000000001011111",	-- instrucción 497
	"000000000000000000000000001011111",	-- instrucción 498
	"000000000000000000000000001011111",	-- instrucción 499
	"000000000000000000000000001011111",	-- instrucción 500
	"000000000000000000000000001011111",	-- instrucción 501
	"000000000000000000000000001011111",	-- instrucción 502
	"000000000000000000000000001011111",	-- instrucción 503
	"000000000000000000000000001011111",	-- instrucción 504
	"000000000000000000000000001011111",	-- instrucción 505
	"000000000000000000000000001011111",	-- instrucción 506
	"000000000000000000000000001011111",	-- instrucción 507
	"000000000000000000000000001011111",	-- instrucción 508
	"000000000000000000000000001011111",	-- instrucción 509
	"000000000000000000000000001011111",	-- instrucción 510
	"000000000000000000000000001011111",	-- instrucción 511
	"000000000000000000000000001011111",	-- instrucción 512
	"000000000000000000000000001011111",	-- instrucción 513
	"000000000000000000000000001011111",	-- instrucción 514
	"000000000000000000000000001011111",	-- instrucción 515
	"000000000000000000000000001011111",	-- instrucción 516
	"000000000000000000000000001011111",	-- instrucción 517
	"000000000000000000000000001011111",	-- instrucción 518
	"000000000000000000000000001011111",	-- instrucción 519
	"000000000000000000000000001011111",	-- instrucción 520
	"000000000000000000000000001011111",	-- instrucción 521
	"000000000000000000000000001011111",	-- instrucción 522
	"000000000000000000000000001011111",	-- instrucción 523
	"000000000000000000000000001011111",	-- instrucción 524
	"000000000000000000000000001011111",	-- instrucción 525
	"000000000000000000000000001011111",	-- instrucción 526
	"000000000000000000000000001011111",	-- instrucción 527
	"000000000000000000000000001011111",	-- instrucción 528
	"000000000000000000000000001011111",	-- instrucción 529
	"000000000000000000000000001011111",	-- instrucción 530
	"000000000000000000000000001011111",	-- instrucción 531
	"000000000000000000000000001011111",	-- instrucción 532
	"000000000000000000000000001011111",	-- instrucción 533
	"000000000000000000000000001011111",	-- instrucción 534
	"000000000000000000000000001011111",	-- instrucción 535
	"000000000000000000000000001011111",	-- instrucción 536
	"000000000000000000000000001011111",	-- instrucción 537
	"000000000000000000000000001011111",	-- instrucción 538
	"000000000000000000000000001011111",	-- instrucción 539
	"000000000000000000000000001011111",	-- instrucción 540
	"000000000000000000000000001011111",	-- instrucción 541
	"000000000000000000000000001011111",	-- instrucción 542
	"000000000000000000000000001011111",	-- instrucción 543
	"000000000000000000000000001011111",	-- instrucción 544
	"000000000000000000000000001011111",	-- instrucción 545
	"000000000000000000000000001011111",	-- instrucción 546
	"000000000000000000000000001011111",	-- instrucción 547
	"000000000000000000000000001011111",	-- instrucción 548
	"000000000000000000000000001011111",	-- instrucción 549
	"000000000000000000000000001011111",	-- instrucción 550
	"000000000000000000000000001011111",	-- instrucción 551
	"000000000000000000000000001011111",	-- instrucción 552
	"000000000000000000000000001011111",	-- instrucción 553
	"000000000000000000000000001011111",	-- instrucción 554
	"000000000000000000000000001011111",	-- instrucción 555
	"000000000000000000000000001011111",	-- instrucción 556
	"000000000000000000000000001011111",	-- instrucción 557
	"000000000000000000000000001011111",	-- instrucción 558
	"000000000000000000000000001011111",	-- instrucción 559
	"000000000000000000000000001011111",	-- instrucción 560
	"000000000000000000000000001011111",	-- instrucción 561
	"000000000000000000000000001011111",	-- instrucción 562
	"000000000000000000000000001011111",	-- instrucción 563
	"000000000000000000000000001011111",	-- instrucción 564
	"000000000000000000000000001011111",	-- instrucción 565
	"000000000000000000000000001011111",	-- instrucción 566
	"000000000000000000000000001011111",	-- instrucción 567
	"000000000000000000000000001011111",	-- instrucción 568
	"000000000000000000000000001011111",	-- instrucción 569
	"000000000000000000000000001011111",	-- instrucción 570
	"000000000000000000000000001011111",	-- instrucción 571
	"000000000000000000000000001011111",	-- instrucción 572
	"000000000000000000000000001011111",	-- instrucción 573
	"000000000000000000000000001011111",	-- instrucción 574
	"000000000000000000000000001011111",	-- instrucción 575
	"000000000000000000000000001011111",	-- instrucción 576
	"000000000000000000000000001011111",	-- instrucción 577
	"000000000000000000000000001011111",	-- instrucción 578
	"000000000000000000000000001011111",	-- instrucción 579
	"000000000000000000000000001011111",	-- instrucción 580
	"000000000000000000000000001011111",	-- instrucción 581
	"000000000000000000000000001011111",	-- instrucción 582
	"000000000000000000000000001011111",	-- instrucción 583
	"000000000000000000000000001011111",	-- instrucción 584
	"000000000000000000000000001011111",	-- instrucción 585
	"000000000000000000000000001011111",	-- instrucción 586
	"000000000000000000000000001011111",	-- instrucción 587
	"000000000000000000000000001011111",	-- instrucción 588
	"000000000000000000000000001011111",	-- instrucción 589
	"000000000000000000000000001011111",	-- instrucción 590
	"000000000000000000000000001011111",	-- instrucción 591
	"000000000000000000000000001011111",	-- instrucción 592
	"000000000000000000000000001011111",	-- instrucción 593
	"000000000000000000000000001011111",	-- instrucción 594
	"000000000000000000000000001011111",	-- instrucción 595
	"000000000000000000000000001011111",	-- instrucción 596
	"000000000000000000000000001011111",	-- instrucción 597
	"000000000000000000000000001011111",	-- instrucción 598
	"000000000000000000000000001011111",	-- instrucción 599
	"000000000000000000000000001011111",	-- instrucción 600
	"000000000000000000000000001011111",	-- instrucción 601
	"000000000000000000000000001011111",	-- instrucción 602
	"000000000000000000000000001011111",	-- instrucción 603
	"000000000000000000000000001011111",	-- instrucción 604
	"000000000000000000000000001011111",	-- instrucción 605
	"000000000000000000000000001011111",	-- instrucción 606
	"000000000000000000000000001011111",	-- instrucción 607
	"000000000000000000000000001011111",	-- instrucción 608
	"000000000000000000000000001011111",	-- instrucción 609
	"000000000000000000000000001011111",	-- instrucción 610
	"000000000000000000000000001011111",	-- instrucción 611
	"000000000000000000000000001011111",	-- instrucción 612
	"000000000000000000000000001011111",	-- instrucción 613
	"000000000000000000000000001011111",	-- instrucción 614
	"000000000000000000000000001011111",	-- instrucción 615
	"000000000000000000000000001011111",	-- instrucción 616
	"000000000000000000000000001011111",	-- instrucción 617
	"000000000000000000000000001011111",	-- instrucción 618
	"000000000000000000000000001011111",	-- instrucción 619
	"000000000000000000000000001011111",	-- instrucción 620
	"000000000000000000000000001011111",	-- instrucción 621
	"000000000000000000000000001011111",	-- instrucción 622
	"000000000000000000000000001011111",	-- instrucción 623
	"000000000000000000000000001011111",	-- instrucción 624
	"000000000000000000000000001011111",	-- instrucción 625
	"000000000000000000000000001011111",	-- instrucción 626
	"000000000000000000000000001011111",	-- instrucción 627
	"000000000000000000000000001011111",	-- instrucción 628
	"000000000000000000000000001011111",	-- instrucción 629
	"000000000000000000000000001011111",	-- instrucción 630
	"000000000000000000000000001011111",	-- instrucción 631
	"000000000000000000000000001011111",	-- instrucción 632
	"000000000000000000000000001011111",	-- instrucción 633
	"000000000000000000000000001011111",	-- instrucción 634
	"000000000000000000000000001011111",	-- instrucción 635
	"000000000000000000000000001011111",	-- instrucción 636
	"000000000000000000000000001011111",	-- instrucción 637
	"000000000000000000000000001011111",	-- instrucción 638
	"000000000000000000000000001011111",	-- instrucción 639
	"000000000000000000000000001011111",	-- instrucción 640
	"000000000000000000000000001011111",	-- instrucción 641
	"000000000000000000000000001011111",	-- instrucción 642
	"000000000000000000000000001011111",	-- instrucción 643
	"000000000000000000000000001011111",	-- instrucción 644
	"000000000000000000000000001011111",	-- instrucción 645
	"000000000000000000000000001011111",	-- instrucción 646
	"000000000000000000000000001011111",	-- instrucción 647
	"000000000000000000000000001011111",	-- instrucción 648
	"000000000000000000000000001011111",	-- instrucción 649
	"000000000000000000000000001011111",	-- instrucción 650
	"000000000000000000000000001011111",	-- instrucción 651
	"000000000000000000000000001011111",	-- instrucción 652
	"000000000000000000000000001011111",	-- instrucción 653
	"000000000000000000000000001011111",	-- instrucción 654
	"000000000000000000000000001011111",	-- instrucción 655
	"000000000000000000000000001011111",	-- instrucción 656
	"000000000000000000000000001011111",	-- instrucción 657
	"000000000000000000000000001011111",	-- instrucción 658
	"000000000000000000000000001011111",	-- instrucción 659
	"000000000000000000000000001011111",	-- instrucción 660
	"000000000000000000000000001011111",	-- instrucción 661
	"000000000000000000000000001011111",	-- instrucción 662
	"000000000000000000000000001011111",	-- instrucción 663
	"000000000000000000000000001011111",	-- instrucción 664
	"000000000000000000000000001011111",	-- instrucción 665
	"000000000000000000000000001011111",	-- instrucción 666
	"000000000000000000000000001011111",	-- instrucción 667
	"000000000000000000000000001011111",	-- instrucción 668
	"000000000000000000000000001011111",	-- instrucción 669
	"000000000000000000000000001011111",	-- instrucción 670
	"000000000000000000000000001011111",	-- instrucción 671
	"000000000000000000000000001011111",	-- instrucción 672
	"000000000000000000000000001011111",	-- instrucción 673
	"000000000000000000000000001011111",	-- instrucción 674
	"000000000000000000000000001011111",	-- instrucción 675
	"000000000000000000000000001011111",	-- instrucción 676
	"000000000000000000000000001011111",	-- instrucción 677
	"000000000000000000000000001011111",	-- instrucción 678
	"000000000000000000000000001011111",	-- instrucción 679
	"000000000000000000000000001011111",	-- instrucción 680
	"000000000000000000000000001011111",	-- instrucción 681
	"000000000000000000000000001011111",	-- instrucción 682
	"000000000000000000000000001011111",	-- instrucción 683
	"000000000000000000000000001011111",	-- instrucción 684
	"000000000000000000000000001011111",	-- instrucción 685
	"000000000000000000000000001011111",	-- instrucción 686
	"000000000000000000000000001011111",	-- instrucción 687
	"000000000000000000000000001011111",	-- instrucción 688
	"000000000000000000000000001011111",	-- instrucción 689
	"000000000000000000000000001011111",	-- instrucción 690
	"000000000000000000000000001011111",	-- instrucción 691
	"000000000000000000000000001011111",	-- instrucción 692
	"000000000000000000000000001011111",	-- instrucción 693
	"000000000000000000000000001011111",	-- instrucción 694
	"000000000000000000000000001011111",	-- instrucción 695
	"000000000000000000000000001011111",	-- instrucción 696
	"000000000000000000000000001011111",	-- instrucción 697
	"000000000000000000000000001011111",	-- instrucción 698
	"000000000000000000000000001011111",	-- instrucción 699
	"000000000000000000000000001011111",	-- instrucción 700
	"000000000000000000000000001011111",	-- instrucción 701
	"000000000000000000000000001011111",	-- instrucción 702
	"000000000000000000000000001011111",	-- instrucción 703
	"000000000000000000000000001011111",	-- instrucción 704
	"000000000000000000000000001011111",	-- instrucción 705
	"000000000000000000000000001011111",	-- instrucción 706
	"000000000000000000000000001011111",	-- instrucción 707
	"000000000000000000000000001011111",	-- instrucción 708
	"000000000000000000000000001011111",	-- instrucción 709
	"000000000000000000000000001011111",	-- instrucción 710
	"000000000000000000000000001011111",	-- instrucción 711
	"000000000000000000000000001011111",	-- instrucción 712
	"000000000000000000000000001011111",	-- instrucción 713
	"000000000000000000000000001011111",	-- instrucción 714
	"000000000000000000000000001011111",	-- instrucción 715
	"000000000000000000000000001011111",	-- instrucción 716
	"000000000000000000000000001011111",	-- instrucción 717
	"000000000000000000000000001011111",	-- instrucción 718
	"000000000000000000000000001011111",	-- instrucción 719
	"000000000000000000000000001011111",	-- instrucción 720
	"000000000000000000000000001011111",	-- instrucción 721
	"000000000000000000000000001011111",	-- instrucción 722
	"000000000000000000000000001011111",	-- instrucción 723
	"000000000000000000000000001011111",	-- instrucción 724
	"000000000000000000000000001011111",	-- instrucción 725
	"000000000000000000000000001011111",	-- instrucción 726
	"000000000000000000000000001011111",	-- instrucción 727
	"000000000000000000000000001011111",	-- instrucción 728
